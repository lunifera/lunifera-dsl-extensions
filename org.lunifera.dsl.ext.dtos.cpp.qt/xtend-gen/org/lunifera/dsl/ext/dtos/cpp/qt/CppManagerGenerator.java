  ...
  public CharSequence toContent(final LTypedPackage pkg) {
    ...
    _builder.newLine();
    {
      ...
      if (_hasSqlCache_2) {
        ...
        _builder.newLine();
        _builder.append("    ");
        _builder.append("QSqlDatabase database = QSqlDatabase::addDatabase(\"QSQLITE\");");
        _builder.newLine();
        _builder.append("    ");
        _builder.append("database.setDatabaseName(dataPath(dbName));");
        _builder.newLine();
        _builder.append("    ");
        _builder.append("if (database.open() == false) {");
        _builder.newLine();
        _builder.append("        ");
        _builder.append("const QSqlError error = database.lastError();");
        _builder.newLine();
        _builder.append("        ");
          ...
          if (_isRootDataObject_4) {
            ...
            _builder.newLine();
            {
              ...
              if (_hasSqlCachePropertyName_1) {
                ...
                _builder.newLineIfNotEmpty();
                _builder.append("    ");
                _builder.append("cacheList = mSQLda->execute(sqlQuery).toList();");
                _builder.newLine();
                _builder.append("    ");
                _builder.append("qDebug() << \"read ");
            ...
            String _firstLower_15 = StringExtensions.toFirstLower(_name_77);
            ...
            _builder.newLine();
            {
              ...
              if (_hasSqlCachePropertyName_2) {
                ...
                _builder.newLineIfNotEmpty();
                _builder.append("    ");
                _builder.append("// to be safe we drop an existing table");
                _builder.newLine();
                _builder.append("    ");
                _builder.append("mSQLda->execute(\"DROP TABLE IF EXISTS ");
                ...
                _builder.append(" Error \" << mSQLda->error().errorMessage();");
                _builder.newLineIfNotEmpty();
                _builder.append("        ");
                ...
                _builder.append("* converted to SQL cache #\" << cacheList.size();");
                _builder.newLineIfNotEmpty();
                _builder.append("    ");
                _builder.append("// HINT: executeBatch command automatically runs in a TRANSACTION to get best results");
                _builder.newLine();
                _builder.append("    ");
                _builder.append("mSQLda->executeBatch(insertSQL, cacheList);");
                _builder.newLine();
                _builder.append("    ");
                _builder.append("if (mSQLda->hasError()) {");
                _builder.newLine();
                _builder.append("        ");
                _builder.append("qWarning() << \"Insert into table ");
                ...
                _builder.append("* inserted into SQLite\";");
                _builder.newLineIfNotEmpty();
                _builder.append("    ");
                _builder.append("}");
                _builder.newLine();
            ...
            }
            {
              ...
              if (_existsLazy) {
                  ...
                  for(final LFeature feature : _filter_7) {
                    {
                      ...
                      if (_isHierarchy) {
                        ...
                        String _name_103 = this._cppExtensions.toName(feature);
                        _builder.append(_name_103, "");
                        _builder.newLineIfNotEmpty();
                        _builder.append("void DataManager::init");
                        String _name_104 = this._cppExtensions.toName(feature);
                        String _firstUpper = StringExtensions.toFirstUpper(_name_104);
                        _builder.append(_firstUpper, "");
                        _builder.append("HierarchyList(");
                        String _name_105 = this._cppExtensions.toName(dto_5);
                        _builder.append(_name_105, "");
                        _builder.append("* ");
                        String _name_106 = this._cppExtensions.toName(feature);
                        ...
                        _builder.append("\t");
                        _builder.append("if (!");
                        String _name_108 = this._cppExtensions.toName(feature);
                        ...
                        String _name_110 = this._cppExtensions.toName(feature);
                        String _firstUpper_1 = StringExtensions.toFirstUpper(_name_110);
                        _builder.append(_firstUpper_1, "\t\t");
                        _builder.append("HierarchyList with ");
                        String _name_111 = this._cppExtensions.toName(dto_5);
                        String _firstLower_24 = StringExtensions.toFirstLower(_name_111);
                        ...
                        _builder.append("*> ");
                        String _name_113 = this._cppExtensions.toName(feature);
                        ...
                        _builder.append(" = ");
                        String _name_117 = this._cppExtensions.toName(feature);
                        ...
                        _builder.append("->has");
                        String _name_120 = this._cppExtensions.toName(feature);
                        String _firstUpper_2 = StringExtensions.toFirstUpper(_name_120);
                        ...
                        _builder.append("->is");
                        String _name_122 = this._cppExtensions.toName(feature);
                        String _firstUpper_3 = StringExtensions.toFirstUpper(_name_122);
                        ...
                        _builder.append("->is");
                        String _name_127 = this._cppExtensions.toName(feature);
                        String _firstUpper_4 = StringExtensions.toFirstUpper(_name_127);
                        ...
                        String _firstLower_33 = StringExtensions.toFirstLower(_name_129);
                        ...
                        String _firstLower_34 = StringExtensions.toFirstLower(_name_130);
                        ...
                        _builder.newLineIfNotEmpty();
                        _builder.append("            \t");
                        String _name_131 = this._cppExtensions.toName(feature);
                        _builder.append(_name_131, "            \t");
                        _builder.append("PropertyList.append(");
                        String _name_132 = this._cppExtensions.toName(dto_5);
                        String _firstLower_35 = StringExtensions.toFirstLower(_name_132);
                        _builder.append(_firstLower_35, "            \t");
                        _builder.append("->");
                        String _name_133 = this._cppExtensions.toName(feature);
                        ...
                        _builder.append("->");
                        String _name_136 = this._cppExtensions.toName(feature);
                        ...
                        String _name_138 = this._cppExtensions.toName(feature);
                        String _firstUpper_5 = StringExtensions.toFirstUpper(_name_138);
                        _builder.append(_firstUpper_5, "\t");
                        _builder.append("HierarchyList DONE with #\" << ");
                        String _name_139 = this._cppExtensions.toName(feature);
                        _builder.append(_name_139, "\t");
                        _builder.append("PropertyList.size();");
                        _builder.newLineIfNotEmpty();
                        _builder.append("    ");
                        String _name_140 = this._cppExtensions.toName(feature);
                        _builder.append(_name_140, "    ");
                        String _name_141 = this._cppExtensions.toName(dto_5);
                        _builder.append(_name_141, "    ");
                        _builder.append("->init");
                        String _name_142 = this._cppExtensions.toName(feature);
                        String _firstUpper_6 = StringExtensions.toFirstUpper(_name_142);
                        _builder.append(_firstUpper_6, "    ");
                        _builder.append("PropertyList(");
                        String _name_143 = this._cppExtensions.toName(feature);
                ...
                String _firstLower_39 = StringExtensions.toFirstLower(_name_146);
                ...
                String _firstLower_40 = StringExtensions.toFirstLower(_name_147);
                ...
                String _firstLower_41 = StringExtensions.toFirstLower(_name_149);
                ...
                String _firstLower_42 = StringExtensions.toFirstLower(_name_150);
                ...
                _builder.newLine();
                {
                  ...
                  for(final LFeature feature_1 : _filter_8) {
                    ...
                    String _firstLower_43 = StringExtensions.toFirstLower(_name_151);
                    _builder.append(_firstLower_43, "    ");
                    _builder.append("->has");
                    String _name_152 = this._cppExtensions.toName(feature_1);
                    String _firstUpper_7 = StringExtensions.toFirstUpper(_name_152);
                    _builder.append(_firstUpper_7, "    ");
                    _builder.append("() && !");
                    String _name_153 = this._cppExtensions.toName(dto_5);
                    String _firstLower_44 = StringExtensions.toFirstLower(_name_153);
                    _builder.append(_firstLower_44, "    ");
                    _builder.append("->is");
                    String _name_154 = this._cppExtensions.toName(feature_1);
                    String _firstUpper_8 = StringExtensions.toFirstUpper(_name_154);
                    ...
                    _builder.append("* ");
                    String _name_155 = this._cppExtensions.toName(feature_1);
                    String _firstLower_45 = StringExtensions.toFirstLower(_name_155);
                    _builder.append(_firstLower_45, "    \t");
                    _builder.append(";");
                    _builder.newLineIfNotEmpty();
                    _builder.append("   \t\t");
                    String _name_156 = this._cppExtensions.toName(feature_1);
                    String _firstLower_46 = StringExtensions.toFirstLower(_name_156);
                    ...
                    String _firstLower_47 = StringExtensions.toFirstLower(_name_157);
                    _builder.append(_firstLower_47, "   \t\t");
                    _builder.append("->");
                    String _name_158 = this._cppExtensions.toName(feature_1);
                    String _firstLower_48 = StringExtensions.toFirstLower(_name_158);
                    ...
                    _builder.append("\t");
                    _builder.append("if (");
                    String _name_159 = this._cppExtensions.toName(feature_1);
                    String _firstLower_49 = StringExtensions.toFirstLower(_name_159);
                    ...
                    String _firstLower_50 = StringExtensions.toFirstLower(_name_160);
                    _builder.append(_firstLower_50, "    \t\t");
                    _builder.append("->resolve");
                    String _name_161 = this._cppExtensions.toName(feature_1);
                    String _firstUpper_10 = StringExtensions.toFirstUpper(_name_161);
                    _builder.append(_firstUpper_10, "    \t\t");
                    _builder.append("AsDataObject(");
                    String _name_162 = this._cppExtensions.toName(feature_1);
                    String _firstLower_51 = StringExtensions.toFirstLower(_name_162);
                    ...
                    String _firstUpper_11 = StringExtensions.toFirstUpper(_name_163);
                    _builder.append(_firstUpper_11, "    \t\t");
                    _builder.append("AsInvalid: \" << ");
                    String _name_164 = this._cppExtensions.toName(dto_5);
                    String _firstLower_52 = StringExtensions.toFirstLower(_name_164);
                    _builder.append(_firstLower_52, "    \t\t");
                    _builder.append("->");
                    String _name_165 = this._cppExtensions.toName(feature_1);
                    String _firstLower_53 = StringExtensions.toFirstLower(_name_165);
                    ...
                    String _firstLower_54 = StringExtensions.toFirstLower(_name_166);
                    _builder.append(_firstLower_54, "    \t\t");
                    _builder.append("->mark");
                    String _name_167 = this._cppExtensions.toName(feature_1);
                    String _firstUpper_12 = StringExtensions.toFirstUpper(_name_167);
                ...
                }
                {
                  ...
                  for(final LFeature feature_2 : _filter_9) {
                    ...
                    String _firstLower_55 = StringExtensions.toFirstLower(_name_168);
                    _builder.append(_firstLower_55, "    ");
                    _builder.append("->are");
                    String _name_169 = this._cppExtensions.toName(feature_2);
                    String _firstUpper_13 = StringExtensions.toFirstUpper(_name_169);
                    ...
                    String _firstLower_56 = StringExtensions.toFirstLower(_name_170);
                    _builder.append(_firstLower_56, "        ");
                    _builder.append("->resolve");
                    String _name_171 = this._cppExtensions.toName(feature_2);
                    String _firstUpper_14 = StringExtensions.toFirstUpper(_name_171);
                    ...
                    String _firstUpper_15 = StringExtensions.toFirstUpper(_name_172);
                ...
                String _firstLower_60 = StringExtensions.toFirstLower(_name_183);
            ...
            String _firstLower_61 = StringExtensions.toFirstLower(_name_189);
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_equals) {
                ...
                String _firstLower_65 = StringExtensions.toFirstLower(_name_195);
                ...
                String _firstLower_67 = StringExtensions.toFirstLower(_name_197);
                ...
                String _firstLower_68 = StringExtensions.toFirstLower(_name_198);
            ...
            String _firstLower_69 = StringExtensions.toFirstLower(_name_200);
            ...
            String _firstLower_70 = StringExtensions.toFirstLower(_name_201);
            ...
            String _firstLower_71 = StringExtensions.toFirstLower(_name_203);
            ...
            String _firstLower_73 = StringExtensions.toFirstLower(_name_210);
            ...
            String _firstLower_78 = StringExtensions.toFirstLower(_name_223);
            ...
            String _firstLower_80 = StringExtensions.toFirstLower(_name_227);
            ...
            String _firstLower_82 = StringExtensions.toFirstLower(_name_232);
            ...
            String _firstLower_85 = StringExtensions.toFirstLower(_name_240);
            ...
            String _firstLower_88 = StringExtensions.toFirstLower(_name_253);
            _builder.append(_firstLower_88, "            ");
            _builder.append(";");
            _builder.newLineIfNotEmpty();
            _builder.append("            ");
            String _name_254 = this._cppExtensions.toName(dto_5);
            String _firstLower_89 = StringExtensions.toFirstLower(_name_254);
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_hasUuid) {
                ...
                String _firstLower_90 = StringExtensions.toFirstLower(_name_258);
            ...
            String _firstLower_96 = StringExtensions.toFirstLower(_name_272);
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_hasUuid_1) {
                ...
                String _firstLower_97 = StringExtensions.toFirstLower(_name_276);
                ...
                if (_hasDomainKey_1) {
                  ...
                  String _firstLower_98 = StringExtensions.toFirstLower(_name_278);
            ...
            String _firstLower_99 = StringExtensions.toFirstLower(_name_280);
            _builder.append(_firstLower_99, "\t\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("        ");
            String _name_281 = this._cppExtensions.toName(dto_5);
            String _firstLower_100 = StringExtensions.toFirstLower(_name_281);
            _builder.append(_firstLower_100, "        ");
            _builder.append("->deleteLater();");
            _builder.newLineIfNotEmpty();
            _builder.append("        ");
            String _name_282 = this._cppExtensions.toName(dto_5);
            String _firstLower_101 = StringExtensions.toFirstLower(_name_282);
            ...
            String _firstLower_106 = StringExtensions.toFirstLower(_name_295);
            ...
            String _firstLower_111 = StringExtensions.toFirstLower(_name_307);
            ...
            String _firstLower_112 = StringExtensions.toFirstLower(_name_310);
            ...
            String _firstLower_113 = StringExtensions.toFirstLower(_name_311);
            ...
            String _firstLower_114 = StringExtensions.toFirstLower(_name_313);
            ...
            String _firstLower_116 = StringExtensions.toFirstLower(_name_317);
            ...
            String _firstLower_120 = StringExtensions.toFirstLower(_name_324);
            _builder.append(_firstLower_120, "        ");
            _builder.append("->fillFromForeignMap(");
            String _name_325 = this._cppExtensions.toName(dto_5);
            String _firstLower_121 = StringExtensions.toFirstLower(_name_325);
            ...
            String _firstLower_122 = StringExtensions.toFirstLower(_name_326);
            _builder.append(_firstLower_122, "        ");
            _builder.append("->fillFromMap(");
            String _name_327 = this._cppExtensions.toName(dto_5);
            String _firstLower_123 = StringExtensions.toFirstLower(_name_327);
            ...
            String _firstLower_124 = StringExtensions.toFirstLower(_name_329);
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_isTree_8) {
                ...
                String _firstLower_125 = StringExtensions.toFirstLower(_name_331);
            ...
            String _firstLower_126 = StringExtensions.toFirstLower(_name_333);
            ...
            String _firstLower_127 = StringExtensions.toFirstLower(_name_336);
            ...
            String _firstLower_128 = StringExtensions.toFirstLower(_name_338);
            ...
            _builder.newLine();
            {
              ...
              if (_isTree_9) {
                ...
                String _firstLower_129 = StringExtensions.toFirstLower(_name_340);
            ...
            }
            {
              ...
              if (_hasUuid_2) {
                ...
                String _firstLower_130 = StringExtensions.toFirstLower(_name_342);
            ...
            String _firstLower_133 = StringExtensions.toFirstLower(_name_347);
            _builder.append(_firstLower_133, "    ");
            _builder.append("->deleteLater();");
            _builder.newLineIfNotEmpty();
            _builder.append("    ");
            String _name_348 = this._cppExtensions.toName(dto_5);
            String _firstLower_134 = StringExtensions.toFirstLower(_name_348);
            ...
            _builder.newLine();
            {
              ...
              if (_hasUuid_3) {
                ...
                String _firstLower_135 = StringExtensions.toFirstLower(_name_353);
                ...
                String _firstLower_139 = StringExtensions.toFirstLower(_name_363);
                _builder.append(_firstLower_139, "            ");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("            ");
                String _name_364 = this._cppExtensions.toName(dto_5);
                String _firstLower_140 = StringExtensions.toFirstLower(_name_364);
            ...
            _builder.newLine();
            {
              ...
              if (_and) {
                ...
                String _firstLower_142 = StringExtensions.toFirstLower(_name_369);
                _builder.append(_firstLower_142, "        ");
                _builder.append(";");
                _builder.newLineIfNotEmpty();
                _builder.append("        ");
                String _name_370 = this._cppExtensions.toName(dto_5);
                String _firstLower_143 = StringExtensions.toFirstLower(_name_370);
                ...
                String _firstLower_144 = StringExtensions.toFirstLower(_name_373);
                ...
                String _firstLower_146 = StringExtensions.toFirstLower(_name_379);
                _builder.append(_firstLower_146, "            ");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("            ");
                String _name_380 = this._cppExtensions.toName(dto_5);
                String _firstLower_147 = StringExtensions.toFirstLower(_name_380);
              ...
              for(final LFeature feature_3 : _filter_10) {
                _builder.newLine();
                {
                  ...
                  if (_isLazy) {
                    ...
                    String _name_403 = this._cppExtensions.toName(feature_3);
                    String _firstUpper_21 = StringExtensions.toFirstUpper(_name_403);
                    ...
                    _builder.append("& ");
                    String _name_404 = this._cppExtensions.toName(feature_3);
                    ...
                    _builder.append("DataModelBy");
                    String _name_406 = this._cppExtensions.toName(feature_3);
                    String _firstUpper_22 = StringExtensions.toFirstUpper(_name_406);
                    _builder.append(_firstUpper_22, "");
                    _builder.append("(QString objectName, const ");
                    String _typeName_2 = this._cppExtensions.toTypeName(feature_3);
                    _builder.append(_typeName_2, "");
                    _builder.append("& ");
                    String _name_407 = this._cppExtensions.toName(feature_3);
                ...
                String _firstLower_149 = StringExtensions.toFirstLower(_name_410);
                ...
                _builder.append("                ");
                _builder.append("if (");
                String _name_414 = this._cppExtensions.toName(dto_5);
                String _firstLower_151 = StringExtensions.toFirstLower(_name_414);
                _builder.append(_firstLower_151, "                ");
                _builder.append("->");
                String _name_415 = this._cppExtensions.toName(feature_3);
                _builder.append(_name_415, "                ");
                _builder.append("() == ");
                String _name_416 = this._cppExtensions.toName(feature_3);
                ...
                _builder.append("DataModelBy");
                String _name_419 = this._cppExtensions.toName(feature_3);
                String _firstUpper_23 = StringExtensions.toFirstUpper(_name_419);
                _builder.append(_firstUpper_23, "            ");
                _builder.append(" \" << ");
                String _name_420 = this._cppExtensions.toName(feature_3);
            ...
            }
            {
              ...
              if (_hasUuid_4) {
                ...
                _builder.append("* ");
                String _name_427 = this._cppExtensions.toName(dto_5);
                String _firstLower_152 = StringExtensions.toFirstLower(_name_427);
                _builder.append(_firstLower_152, "        ");
                _builder.append(";");
                _builder.newLineIfNotEmpty();
                _builder.append("        ");
                String _name_428 = this._cppExtensions.toName(dto_5);
                String _firstLower_153 = StringExtensions.toFirstLower(_name_428);
                ...
                String _firstLower_154 = StringExtensions.toFirstLower(_name_431);
                ...
                String _firstLower_155 = StringExtensions.toFirstLower(_name_432);
