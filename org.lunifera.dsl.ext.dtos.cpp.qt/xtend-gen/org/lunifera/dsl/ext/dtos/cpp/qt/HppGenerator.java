  ...
  public CharSequence toContent(final LDto dto) {
      ...
      for(final LFeature feature : _filter_7) {
        {
          ...
          if (_and) {
            ...
            if (_isLazy) {
              ...
              if (_isEnum) {
                _builder.append("\t");
                _builder.append("// int OrderState::OrderStateEnum");
                _builder.newLine();
                _builder.append("\t");
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_1 : _filter_8) {
        ...
        String _typeName_4 = this._cppExtensions.toTypeName(feature_1);
      ...
      for(final LFeature feature_2 : _filter_9) {
        {
          ...
          if (_equals) {
            ...
            String _firstUpper_5 = StringExtensions.toFirstUpper(_name_29);
    ...
    String _firstLower = StringExtensions.toFirstLower(_name_32);
      ...
      for(final LFeature feature_3 : _filter_10) {
        {
          ...
          if (_isLazy_1) {
            ...
            String _firstUpper_8 = StringExtensions.toFirstUpper(_name_39);
            ...
            if (_isEnum_1) {
              ...
              _builder.newLineIfNotEmpty();
              {
                ...
                if (_and_1) {
                  ...
                  String _firstUpper_11 = StringExtensions.toFirstUpper(_name_46);
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_isTypeOfDTO_2) {
                      ...
                      String _firstUpper_12 = StringExtensions.toFirstUpper(_name_48);
                      ...
                      String _firstUpper_13 = StringExtensions.toFirstUpper(_name_49);
      ...
      for(final LFeature feature_4 : _filter_11) {
        {
          ...
          if (_not_1) {
            ...
            String _firstUpper_14 = StringExtensions.toFirstUpper(_name_51);
            ...
            String _firstLower_1 = StringExtensions.toFirstLower(_typeName_8);
            ...
            String _firstUpper_15 = StringExtensions.toFirstUpper(_name_52);
            ...
            String _firstLower_2 = StringExtensions.toFirstLower(_typeName_10);
          ...
          } else {
            {
              ...
              boolean _equals_1 = Objects.equal(_typeName_12, "QString");
              if (_equals_1) {
                _builder.append("\t");
                _builder.append("Q_INVOKABLE");
                _builder.newLine();
                ...
                String _firstUpper_21 = StringExtensions.toFirstUpper(_typeName_18);
                ...
                String _firstUpper_23 = StringExtensions.toFirstUpper(_typeName_20);
        ...
        String _firstLower_6 = StringExtensions.toFirstLower(_name_59);
        ...
        _builder.newLine();
        {
          ...
          if (_not_2) {
          ...
          } else {
            {
              ...
              boolean _equals_2 = Objects.equal(_typeName_24, "QString");
              if (_equals_2) {
                _builder.append("\t");
                ...
                String _firstUpper_26 = StringExtensions.toFirstUpper(_name_71);
      ...
      for(final LFeature feature_5 : _filter_12) {
        {
          ...
          if (_isLazy_2) {
            ...
            _builder.append(" ");
            String _name_82 = this._cppExtensions.toName(feature_5);
            _builder.append(_name_82, "\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("void request");
            String _name_83 = this._cppExtensions.toName(feature_5);
            ...
            _builder.append(" ");
            String _name_84 = this._cppExtensions.toName(feature_5);
            ...
            if (_isEnum_2) {
              _builder.append("\t");
              _builder.append("void ");
              String _name_85 = this._cppExtensions.toName(feature_5);
                ...
                if (_and_2) {
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_isTypeOfDTO_4) {
                      ...
                      String _firstLower_7 = StringExtensions.toFirstLower(_name_90);
      ...
      for(final LFeature feature_6 : _filter_13) {
        {
          ...
          if (_not_3) {
            ...
            String _firstUpper_30 = StringExtensions.toFirstUpper(_name_93);
            ...
            String _firstLower_8 = StringExtensions.toFirstLower(_typeName_30);
            _builder.append(_firstLower_8, "\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("void removedFrom");
            String _name_94 = this._cppExtensions.toName(feature_6);
            String _firstUpper_31 = StringExtensions.toFirstUpper(_name_94);
          ...
          } else {
            {
              ...
              boolean _equals_3 = Objects.equal(_typeName_31, "QString");
              if (_equals_3) {
                _builder.append("\t");
                _builder.append("void ");
                String _name_95 = this._cppExtensions.toName(feature_6);
                ...
                String _firstLower_9 = StringExtensions.toFirstLower(_typeName_33);
                ...
                String _firstUpper_33 = StringExtensions.toFirstUpper(_name_98);
                ...
                String _firstLower_10 = StringExtensions.toFirstLower(_typeName_35);
                ...
                String _firstUpper_34 = StringExtensions.toFirstUpper(_name_101);
                ...
                String _firstUpper_35 = StringExtensions.toFirstUpper(_typeName_37);
                ...
                String _firstUpper_37 = StringExtensions.toFirstUpper(_typeName_39);
          ...
          for(final LFeature feature_7 : _filter_14) {
            {
              ...
              if (_isLazy_3) {
                ...
                _builder.append(" ");
                String _typeName_40 = this._cppExtensions.toTypeName(feature_7);
                String _firstLower_11 = StringExtensions.toFirstLower(_typeName_40);
      ...
      for(final LFeature feature_8 : _filter_15) {
        {
          ...
          if (_and_3) {
            ...
            String _firstUpper_40 = StringExtensions.toFirstUpper(_name_105);
            ...
            if (_isLazy_4) {
              ...
              String _firstUpper_41 = StringExtensions.toFirstUpper(_name_106);
      ...
      for(final LFeature feature_9 : _filter_16) {
        {
          ...
          if (_not_4) {
            ...
            String _firstUpper_45 = StringExtensions.toFirstUpper(_name_110);
            ...
            String _firstUpper_46 = StringExtensions.toFirstUpper(_name_111);
            ...
            String _firstLower_12 = StringExtensions.toFirstLower(_typeName_45);
            ...
            _builder.append("> *");
            String _name_116 = this._cppExtensions.toName(feature_9);
            ...
            String _firstUpper_48 = StringExtensions.toFirstUpper(_name_117);
          ...
          } else {
            {
              ...
              boolean _equals_4 = Objects.equal(_typeName_50, "QString");
              if (_equals_4) {
                _builder.append("\t");
                ...
                _builder.append("\t");
                _builder.append("QList<");
                String _typeName_51 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_51, "\t");
                _builder.append("> m");
                String _name_120 = this._cppExtensions.toName(feature_9);
                String _firstUpper_50 = StringExtensions.toFirstUpper(_name_120);
    ...
    String _firstUpper_51 = StringExtensions.toFirstUpper(_name_121);
    ...
    String _firstUpper_52 = StringExtensions.toFirstUpper(_name_122);
    ...
    String _upperCase_2 = _name_123.toUpperCase();
