...
public class HppGenerator {
  ...
  public CharSequence toContent(final LDto dto) {
            ...
            if (_isEnum_1) {
              ...
              _builder.newLineIfNotEmpty();
              {
                ...
                if (_isTypeOfDates) {
                  ...
                  String _firstUpper_12 = StringExtensions.toFirstUpper(_name_47);
          ...
          if (_not_1) {
          ...
          } else {
            {
              ...
              if (_equals_1) {
                ...
                String _firstUpper_22 = StringExtensions.toFirstUpper(_name_60);
                ...
                String _firstUpper_23 = StringExtensions.toFirstUpper(_typeName_19);
                ...
                String _firstUpper_25 = StringExtensions.toFirstUpper(_typeName_21);
    ...
    String _firstUpper_30 = StringExtensions.toFirstUpper(_name_80);
                ...
                if (_and_2) {
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_isTypeOfDataObject_4) {
                      ...
                      String _firstLower_7 = StringExtensions.toFirstLower(_name_93);
      ...
      for(final LFeature feature_6 : _filter_13) {
        {
          ...
          if (_not_3) {
            ...
            String _firstUpper_33 = StringExtensions.toFirstUpper(_name_97);
          ...
          } else {
            {
              ...
              if (_equals_3) {
                ...
                String _firstUpper_36 = StringExtensions.toFirstUpper(_name_104);
                ...
                String _firstUpper_37 = StringExtensions.toFirstUpper(_typeName_38);
                ...
                String _firstUpper_39 = StringExtensions.toFirstUpper(_typeName_40);
      ...
      for(final LFeature feature_9 : _filter_16) {
        {
          ...
          if (_not_4) {
            ...
            String _firstUpper_49 = StringExtensions.toFirstUpper(_name_120);
            ...
            String _firstUpper_50 = StringExtensions.toFirstUpper(_name_122);
    ...
    String _upperCase_2 = _name_128.toUpperCase();
