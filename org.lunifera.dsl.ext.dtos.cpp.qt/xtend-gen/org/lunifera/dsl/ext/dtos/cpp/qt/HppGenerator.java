  ...
  public CharSequence toContent(final LDto dto) {
      ...
      for(final LFeature reference : _filter_6) {
        {
          ...
          if (_not) {
              ...
              if (_notEquals) {
                {
                  ...
                  if (_isReferencing) {
                  ...
                  } else {
                    {
                      ...
                      if (_or) {
                        _builder.append("#include \"../");
                        String _typeName_5 = this._cppExtensions.toTypeName(reference);
                        _builder.append(_typeName_5, "");
                        _builder.append(".hpp\"");
                        _builder.newLineIfNotEmpty();
                      } else {
                        _builder.append("#include \"");
                        String _typeName_6 = this._cppExtensions.toTypeName(reference);
            ...
            _builder.newLine();
            _builder.append("class ");
            String _typeName_7 = this._cppExtensions.toTypeName(reference);
            String _firstUpper_1 = StringExtensions.toFirstUpper(_typeName_7);
          ...
          if (_and) {
            ...
            if (_isLazy) {
              ...
              _builder.newLineIfNotEmpty();
              {
                ...
                if (_isHierarchy) {
                  {
                    boolean _hasTargetOSPropertyName_2 = this._cppExtensions.hasTargetOSPropertyName(dto);
                    if (_hasTargetOSPropertyName_2) {
                      _builder.append("\t");
                      _builder.append("// QQmlListProperty to get easy access to hierarchy of ");
              ...
              if (_isEnum) {
                ...
                String _typeName_8 = this._cppExtensions.toTypeName(feature);
                ...
                _builder.append(" WRITE set");
                String _name_28 = this._cppExtensions.toName(feature);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_1 : _filter_8) {
        {
          boolean _hasTargetOSPropertyName_3 = this._cppExtensions.hasTargetOSPropertyName(dto);
          if (_hasTargetOSPropertyName_3) {
            _builder.append("\t");
            ...
            _builder.append("> ");
            String _name_34 = this._cppExtensions.toName(feature_1);
            _builder.append(_name_34, "\t");
            _builder.append("PropertyList READ ");
            String _name_35 = this._cppExtensions.toName(feature_1);
            _builder.append(_name_35, "\t");
            _builder.append("PropertyList NOTIFY ");
            String _name_36 = this._cppExtensions.toName(feature_1);
            ...
            _builder.append("> ");
            String _name_37 = this._cppExtensions.toName(feature_1);
            _builder.append(_name_37, "\t");
            _builder.append("PropertyList READ ");
            String _name_38 = this._cppExtensions.toName(feature_1);
            _builder.append(_name_38, "\t");
            _builder.append("PropertyList NOTIFY ");
            String _name_39 = this._cppExtensions.toName(feature_1);
    ...
    }
    {
      ...
      for(final LFeature feature_2 : _filter_9) {
        {
          String _typeName_11 = this._cppExtensions.toTypeName(feature_2);
          boolean _equals_2 = Objects.equal(_typeName_11, "QString");
          if (_equals_2) {
            _builder.append("\t");
            _builder.append("Q_PROPERTY(QStringList ");
            String _name_40 = this._cppExtensions.toName(feature_2);
            _builder.append(_name_40, "\t");
            _builder.append("StringList READ ");
            String _name_41 = this._cppExtensions.toName(feature_2);
            _builder.append(_name_41, "\t");
            _builder.append("StringList  WRITE set");
            String _name_42 = this._cppExtensions.toName(feature_2);
            String _firstUpper_8 = StringExtensions.toFirstUpper(_name_42);
            _builder.append(_firstUpper_8, "\t");
            _builder.append("StringList NOTIFY ");
            String _name_43 = this._cppExtensions.toName(feature_2);
            ...
            String _typeName_12 = this._cppExtensions.toTypeName(feature_2);
            _builder.append(_typeName_12, "\t");
            _builder.append(" Array");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("Q_PROPERTY(QVariantList ");
            String _name_44 = this._cppExtensions.toName(feature_2);
            _builder.append(_name_44, "\t");
            _builder.append("List READ ");
            String _name_45 = this._cppExtensions.toName(feature_2);
            _builder.append(_name_45, "\t");
            _builder.append("List  WRITE set");
            String _name_46 = this._cppExtensions.toName(feature_2);
            String _firstUpper_9 = StringExtensions.toFirstUpper(_name_46);
            _builder.append(_firstUpper_9, "\t");
            _builder.append("List NOTIFY ");
            String _name_47 = this._cppExtensions.toName(feature_2);
    ...
    String _firstLower = StringExtensions.toFirstLower(_name_49);
    ...
    String _firstLower_1 = StringExtensions.toFirstLower(_name_50);
    ...
    String _firstLower_2 = StringExtensions.toFirstLower(_name_51);
      ...
      for(final LFeature feature_3 : _filter_10) {
        {
          ...
          if (_isLazy_1) {
            ...
            String _firstUpper_10 = StringExtensions.toFirstUpper(_name_54);
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_isHierarchy_1) {
                ...
                String _firstUpper_11 = StringExtensions.toFirstUpper(_name_57);
                ...
                String _firstUpper_12 = StringExtensions.toFirstUpper(_name_58);
                _builder.append(_firstUpper_12, "\t");
                _builder.append("PropertyList(QList<");
                String _name_59 = dto.getName();
                ...
                String _firstUpper_13 = StringExtensions.toFirstUpper(_name_61);
                _builder.append(_firstUpper_13, "\t");
                _builder.append("PropertyList();");
                _builder.newLineIfNotEmpty();
                {
                  boolean _hasTargetOSPropertyName_4 = this._cppExtensions.hasTargetOSPropertyName(dto);
                  if (_hasTargetOSPropertyName_4) {
                    _builder.append("\t");
                    _builder.append("QQmlListProperty<");
                    String _name_62 = dto.getName();
            ...
            String _firstUpper_14 = StringExtensions.toFirstUpper(_name_66);
            _builder.append(_firstUpper_14, "\t");
            _builder.append("AsDataObject(");
            String _typeName_13 = this._cppExtensions.toTypeName(feature_3);
            String _firstUpper_15 = StringExtensions.toFirstUpper(_typeName_13);
            _builder.append(_firstUpper_15, "\t");
            _builder.append("* ");
            String _typeName_14 = this._cppExtensions.toTypeName(feature_3);
            String _firstLower_3 = StringExtensions.toFirstLower(_typeName_14);
            ...
            String _firstUpper_16 = StringExtensions.toFirstUpper(_name_67);
            ...
            String _firstUpper_17 = StringExtensions.toFirstUpper(_name_68);
            ...
            String _firstUpper_18 = StringExtensions.toFirstUpper(_name_69);
            ...
            String _firstUpper_19 = StringExtensions.toFirstUpper(_name_70);
            ...
            if (_isEnum_1) {
              ...
              String _firstUpper_20 = StringExtensions.toFirstUpper(_name_72);
              ...
              String _firstUpper_21 = StringExtensions.toFirstUpper(_name_74);
              _builder.append(_firstUpper_21, "\t");
              _builder.append("(QString ");
              String _name_75 = this._cppExtensions.toName(feature_3);
              ...
              _builder.append(" ");
              String _name_76 = this._cppExtensions.toName(feature_3);
              ...
              _builder.newLineIfNotEmpty();
              {
                ...
                if (_isTypeOfDates) {
                  ...
                  _builder.append("\t");
                  _builder.append("bool has");
                  String _name_77 = this._cppExtensions.toName(feature_3);
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    boolean _equals_3 = Objects.equal(_typeName_15, "QTime");
                    if (_equals_3) {
                      _builder.newLine();
                      _builder.append("\t");
                      _builder.append("Q_INVOKABLE");
                      ...
                      _builder.append("\t");
                      _builder.append("void set");
                      String _name_78 = this._cppExtensions.toName(feature_3);
                      String _firstUpper_23 = StringExtensions.toFirstUpper(_name_78);
                      _builder.append(_firstUpper_23, "\t");
                      _builder.append("FromPickerValue(QString ");
                      String _name_79 = this._cppExtensions.toName(feature_3);
                      String _firstLower_4 = StringExtensions.toFirstLower(_name_79);
              ...
              }
              {
                ...
                if (_and_1) {
                  ...
                  String _name_80 = this._cppExtensions.toName(feature_3);
                  ...
                  _builder.append("\t");
                  _builder.append("void set");
                  String _name_81 = this._cppExtensions.toName(feature_3);
                  ...
                  _builder.append(" ");
                  String _name_82 = this._cppExtensions.toName(feature_3);
                    ...
                    if (_isTypeOfDataObject_2) {
                      {
                        ...
                        boolean _equals_4 = Objects.equal(_typeName_16, "GeoAddress");
                        boolean _not_1 = (!_equals_4);
                        if (!_not_1) {
                          _and_2 = false;
                        } else {
                          String _typeName_17 = this._cppExtensions.toTypeName(feature_3);
                          boolean _equals_5 = Objects.equal(_typeName_17, "GeoCoordinate");
                        ...
                        if (_and_2) {
                          ...
                          _builder.newLine();
                          _builder.append("\t");
                          String _typeName_18 = this._cppExtensions.toTypeName(feature_3);
                          ...
                          String _name_84 = this._cppExtensions.toName(feature_3);
                          String _firstUpper_26 = StringExtensions.toFirstUpper(_name_84);
                          _builder.append(_firstUpper_26, "\t");
                          _builder.append("(");
                          String _typeName_19 = this._cppExtensions.toTypeName(feature_3);
                          _builder.append(_typeName_19, "\t");
                          _builder.append("* ");
                          String _typeName_20 = this._cppExtensions.toTypeName(feature_3);
                          String _firstLower_5 = StringExtensions.toFirstLower(_typeName_20);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_4 : _filter_11) {
          ...
          if (_not_3) {
            ...
            _builder.newLine();
            {
              ...
              if (_not_4) {
                ...
                String _firstLower_6 = StringExtensions.toFirstLower(_typeName_23);
            ...
            String _firstLower_7 = StringExtensions.toFirstLower(_typeName_25);
            ...
            String _firstLower_8 = StringExtensions.toFirstLower(_typeName_27);
            ...
            _builder.newLine();
            {
              ...
              if (_isLazyArray) {
                ...
                String _firstLower_9 = StringExtensions.toFirstLower(_name_96);
                ...
                String _firstLower_10 = StringExtensions.toFirstLower(_name_98);
            ...
            }
            {
              ...
              if (_not_5) {
                ...
                String _firstLower_11 = StringExtensions.toFirstLower(_typeName_29);
            ...
            }
            {
              ...
              if (_and_3) {
                ...
                String _firstUpper_39 = StringExtensions.toFirstUpper(_referenceDomainKey_3);
            ...
            _builder.newLine();
            {
              ...
              boolean _equals_6 = Objects.equal(_typeName_30, "QString");
              if (_equals_6) {
                _builder.append("\t");
                _builder.append("Q_INVOKABLE");
                _builder.newLine();
                ...
                String _firstUpper_40 = StringExtensions.toFirstUpper(_name_102);
                ...
                String _firstUpper_41 = StringExtensions.toFirstUpper(_name_103);
                ...
                String _firstUpper_42 = StringExtensions.toFirstUpper(_name_104);
                ...
                String _firstLower_12 = StringExtensions.toFirstLower(_typeName_34);
                ...
                String _firstUpper_43 = StringExtensions.toFirstUpper(_name_105);
                ...
                String _firstLower_13 = StringExtensions.toFirstLower(_typeName_36);
        ...
        String _firstLower_14 = StringExtensions.toFirstLower(_name_106);
        ...
        _builder.newLine();
        {
          ...
          if (_not_6) {
            ...
            String _firstUpper_44 = StringExtensions.toFirstUpper(_name_109);
            _builder.append(_firstUpper_44, "\t");
            _builder.append("(QList<");
            String _typeName_38 = this._cppExtensions.toTypeName(feature_4);
            _builder.append(_typeName_38, "\t");
            _builder.append("*> ");
            String _name_110 = this._cppExtensions.toName(feature_4);
            _builder.append(_name_110, "\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("// access from QML to ");
            String _name_111 = this._cppExtensions.toName(feature_4);
            _builder.append(_name_111, "\t");
            _builder.newLineIfNotEmpty();
            {
              boolean _hasTargetOSPropertyName_5 = this._cppExtensions.hasTargetOSPropertyName(dto);
              if (_hasTargetOSPropertyName_5) {
                _builder.append("\t");
                _builder.append("QQmlListProperty<");
                String _typeName_39 = this._cppExtensions.toTypeName(feature_4);
                _builder.append(_typeName_39, "\t");
                _builder.append("> ");
                String _name_112 = this._cppExtensions.toName(feature_4);
                ...
                _builder.append("\t");
                _builder.append("QDeclarativeListProperty<");
                String _typeName_40 = this._cppExtensions.toTypeName(feature_4);
                _builder.append(_typeName_40, "\t");
                _builder.append("> ");
                String _name_113 = this._cppExtensions.toName(feature_4);
            ...
            {
              String _typeName_41 = this._cppExtensions.toTypeName(feature_4);
              boolean _equals_7 = Objects.equal(_typeName_41, "QString");
              if (_equals_7) {
                _builder.append("\t");
                _builder.append("QStringList ");
                String _name_114 = this._cppExtensions.toName(feature_4);
                _builder.append(_name_114, "\t");
                _builder.append("StringList();");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("void set");
                String _name_115 = this._cppExtensions.toName(feature_4);
                ...
                String _name_116 = this._cppExtensions.toName(feature_4);
                ...
                _builder.append("\t");
                _builder.append("// access from C++ to ");
                String _name_117 = this._cppExtensions.toName(feature_4);
                _builder.append(_name_117, "\t");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("QList<");
                String _typeName_42 = this._cppExtensions.toTypeName(feature_4);
                _builder.append(_typeName_42, "\t");
                _builder.append("> ");
                String _name_118 = this._cppExtensions.toName(feature_4);
                _builder.append(_name_118, "\t");
                _builder.append("();");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("void set");
                String _name_119 = this._cppExtensions.toName(feature_4);
                String _firstUpper_46 = StringExtensions.toFirstUpper(_name_119);
                _builder.append(_firstUpper_46, "\t");
                _builder.append("(QList<");
                String _typeName_43 = this._cppExtensions.toTypeName(feature_4);
                _builder.append(_typeName_43, "\t");
                _builder.append("> ");
                String _name_120 = this._cppExtensions.toName(feature_4);
                _builder.append(_name_120, "\t");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("// access from QML to ");
                String _name_121 = this._cppExtensions.toName(feature_4);
                _builder.append(_name_121, "\t");
                _builder.append(" (array of ");
                String _typeName_44 = this._cppExtensions.toTypeName(feature_4);
                _builder.append(_typeName_44, "\t");
                _builder.append(")");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("QVariantList ");
                String _name_122 = this._cppExtensions.toName(feature_4);
                _builder.append(_name_122, "\t");
                _builder.append("List();");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("void set");
                String _name_123 = this._cppExtensions.toName(feature_4);
                ...
                String _name_124 = this._cppExtensions.toName(feature_4);
    ...
    _builder.newLine();
    {
      ...
      if (_isTree) {
        ...
        String _firstUpper_48 = StringExtensions.toFirstUpper(_name_125);
      ...
      if (_hasSqlCachePropertyName_1) {
        ...
        _builder.append("void toSqlCache(");
        {
          ...
          for(final LDtoFeature feature_5 : _features) {
            ...
            _builder.append("QVariantList& ");
            String _name_126 = this._cppExtensions.toName(feature_5);
      ...
      for(final LFeature feature_6 : _filter_12) {
        {
          ...
          if (_isLazy_2) {
            _builder.append("\t");
            _builder.append("// ");
            String _name_128 = this._cppExtensions.toName(feature_6);
            ...
            String _name_129 = this._cppExtensions.toName(feature_6);
            ...
            _builder.append(" ");
            String _name_130 = this._cppExtensions.toName(feature_6);
            _builder.append(_name_130, "\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("void ");
            String _name_131 = this._cppExtensions.toName(feature_6);
            _builder.append(_name_131, "\t");
            _builder.append("AsDataObjectChanged(");
            String _typeName_45 = this._cppExtensions.toTypeName(feature_6);
            _builder.append(_typeName_45, "\t");
            _builder.append("* ");
            String _typeName_46 = this._cppExtensions.toTypeName(feature_6);
            String _firstLower_15 = StringExtensions.toFirstLower(_typeName_46);
            ...
            if (_isEnum_2) {
              _builder.append("\t");
              _builder.append("void ");
              String _name_132 = this._cppExtensions.toName(feature_6);
              _builder.append(_name_132, "\t");
              _builder.append("Changed(int ");
              String _name_133 = this._cppExtensions.toName(feature_6);
            ...
            } else {
              {
                ...
                if (_and_4) {
                  ...
                  String _name_134 = this._cppExtensions.toName(feature_6);
                  ...
                  _builder.append("\t");
                  _builder.append("void ");
                  String _name_135 = this._cppExtensions.toName(feature_6);
                  ...
                  _builder.append(" ");
                  String _name_136 = this._cppExtensions.toName(feature_6);
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_isTypeOfDataObject_4) {
                      _builder.append("\t");
                      _builder.append("void ");
                      String _name_137 = this._cppExtensions.toName(feature_6);
                      String _firstLower_16 = StringExtensions.toFirstLower(_name_137);
      ...
      for(final LFeature feature_7 : _filter_13) {
        {
          ...
          if (_not_7) {
            _builder.append("\t");
            _builder.append("void ");
            String _name_138 = this._cppExtensions.toName(feature_7);
            ...
            _builder.append("*> ");
            String _name_139 = this._cppExtensions.toName(feature_7);
            _builder.append(_name_139, "\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("void addedTo");
            String _name_140 = this._cppExtensions.toName(feature_7);
            ...
            String _firstLower_17 = StringExtensions.toFirstLower(_typeName_49);
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_referenceHasUuid_1) {
                ...
                String _name_141 = this._cppExtensions.toName(feature_7);
            ...
            }
            {
              ...
              if (_and_5) {
                _builder.append("\t");
                _builder.append("void removedFrom");
                String _name_142 = this._cppExtensions.toName(feature_7);
                ...
                String _firstUpper_53 = StringExtensions.toFirstUpper(_referenceDomainKey_7);
            ...
            _builder.append("\t");
            _builder.append("void ");
            String _name_143 = this._cppExtensions.toName(feature_7);
          ...
          } else {
            {
              ...
              boolean _equals_8 = Objects.equal(_typeName_50, "QString");
              if (_equals_8) {
                _builder.append("\t");
                _builder.append("void ");
                String _name_144 = this._cppExtensions.toName(feature_7);
                _builder.append(_name_144, "\t");
                _builder.append("StringListChanged(QStringList ");
                String _name_145 = this._cppExtensions.toName(feature_7);
                _builder.append(_name_145, "\t");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("void addedTo");
                String _name_146 = this._cppExtensions.toName(feature_7);
                String _firstUpper_54 = StringExtensions.toFirstUpper(_name_146);
                ...
                _builder.append("\t");
                _builder.append("void removedFrom");
                String _name_147 = this._cppExtensions.toName(feature_7);
                String _firstUpper_55 = StringExtensions.toFirstUpper(_name_147);
                _builder.append(_firstUpper_55, "\t");
                _builder.append("StringList(");
                String _typeName_52 = this._cppExtensions.toTypeName(feature_7);
                ...
                _builder.append("\t");
                _builder.append("void ");
                String _name_148 = this._cppExtensions.toName(feature_7);
                _builder.append(_name_148, "\t");
                _builder.append("ListChanged(QVariantList ");
                String _name_149 = this._cppExtensions.toName(feature_7);
                _builder.append(_name_149, "\t");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("void addedTo");
                String _name_150 = this._cppExtensions.toName(feature_7);
                String _firstUpper_56 = StringExtensions.toFirstUpper(_name_150);
                _builder.append(_firstUpper_56, "\t");
                _builder.append("List(");
                String _typeName_53 = this._cppExtensions.toTypeName(feature_7);
                _builder.append(_typeName_53, "\t");
                _builder.append(" ");
                String _typeName_54 = this._cppExtensions.toTypeName(feature_7);
                String _firstLower_18 = StringExtensions.toFirstLower(_typeName_54);
                _builder.append(_firstLower_18, "\t");
                _builder.append("Value);");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("void removedFrom");
                String _name_151 = this._cppExtensions.toName(feature_7);
                String _firstUpper_57 = StringExtensions.toFirstUpper(_name_151);
                _builder.append(_firstUpper_57, "\t");
                _builder.append("List(");
                String _typeName_55 = this._cppExtensions.toTypeName(feature_7);
                _builder.append(_typeName_55, "\t");
                _builder.append(" ");
                String _typeName_56 = this._cppExtensions.toTypeName(feature_7);
                String _firstLower_19 = StringExtensions.toFirstLower(_typeName_56);
      ...
      for(final LFeature feature_8 : _filter_14) {
        {
          ...
          if (_and_6) {
            ...
            String _firstUpper_58 = StringExtensions.toFirstUpper(_name_152);
            ...
            if (_isLazy_3) {
              ...
              _builder.append(" m");
              String _name_153 = this._cppExtensions.toName(feature_8);
              String _firstUpper_59 = StringExtensions.toFirstUpper(_name_153);
              ...
              String _firstUpper_60 = StringExtensions.toFirstUpper(_name_154);
              ...
              _builder.append(" m");
              String _name_155 = this._cppExtensions.toName(feature_8);
              String _firstUpper_61 = StringExtensions.toFirstUpper(_name_155);
              ...
              _builder.newLineIfNotEmpty();
              {
                ...
                if (_isHierarchy_2) {
                  ...
                  String _firstUpper_62 = StringExtensions.toFirstUpper(_name_157);
                  ...
                  String _firstUpper_63 = StringExtensions.toFirstUpper(_name_159);
                  _builder.append(_firstUpper_63, "\t");
                  _builder.append("AsPropertyList;");
                  _builder.newLineIfNotEmpty();
                  {
                    boolean _hasTargetOSPropertyName_6 = this._cppExtensions.hasTargetOSPropertyName(dto);
                    if (_hasTargetOSPropertyName_6) {
                      _builder.append("\t");
                      ...
                      String _firstUpper_64 = StringExtensions.toFirstUpper(_name_161);
                      ...
                      String _firstLower_20 = StringExtensions.toFirstLower(_name_165);
                      _builder.append(_firstLower_20, "\t\t");
                      _builder.append(");");
                      _builder.newLineIfNotEmpty();
                      _builder.append("\t");
                      _builder.append("static int ");
                      String _name_166 = this._cppExtensions.toName(feature_8);
                      ...
                      _builder.append("> *");
                      String _name_168 = this._cppExtensions.toName(feature_8);
                      ...
                      _builder.append("* at");
                      String _name_170 = this._cppExtensions.toName(feature_8);
                      String _firstUpper_65 = StringExtensions.toFirstUpper(_name_170);
                      _builder.append(_firstUpper_65, "\t");
                      _builder.append("Property(QQmlListProperty<");
                      String _name_171 = this._cppExtensions.toName(dto);
                      _builder.append(_name_171, "\t");
                      _builder.append("> *");
                      String _name_172 = this._cppExtensions.toName(feature_8);
                      ...
                      String _name_173 = this._cppExtensions.toName(feature_8);
                      String _firstUpper_66 = StringExtensions.toFirstUpper(_name_173);
                      _builder.append(_firstUpper_66, "\t");
                      _builder.append("Property(QQmlListProperty<");
                      String _name_174 = this._cppExtensions.toName(dto);
                      _builder.append(_name_174, "\t");
                      _builder.append("> *");
                      String _name_175 = this._cppExtensions.toName(feature_8);
                      ...
                      _builder.append("\t");
                      _builder.append("static void appendTo");
                      String _name_177 = this._cppExtensions.toName(feature_8);
                      String _firstUpper_67 = StringExtensions.toFirstUpper(_name_177);
                      ...
                      _builder.append("> *");
                      String _name_179 = this._cppExtensions.toName(feature_8);
                      ...
                      String _firstLower_21 = StringExtensions.toFirstLower(_name_181);
                      _builder.append(_firstLower_21, "\t\t");
                      _builder.append(");");
                      _builder.newLineIfNotEmpty();
                      _builder.append("\t");
                      _builder.append("static int ");
                      String _name_182 = this._cppExtensions.toName(feature_8);
                      ...
                      _builder.append("> *");
                      String _name_184 = this._cppExtensions.toName(feature_8);
                      ...
                      _builder.append("* at");
                      String _name_186 = this._cppExtensions.toName(feature_8);
                      ...
                      _builder.append("> *");
                      String _name_188 = this._cppExtensions.toName(feature_8);
                      ...
                      _builder.append("\t");
                      _builder.append("static void clear");
                      String _name_189 = this._cppExtensions.toName(feature_8);
                      ...
                      _builder.append("> *");
                      String _name_191 = this._cppExtensions.toName(feature_8);
              ...
              if (_isEnum_3) {
                ...
                String _name_192 = this._cppExtensions.toName(feature_8);
                ...
                _builder.append("\t");
                _builder.append("int ");
                String _name_193 = this._cppExtensions.toName(feature_8);
                String _firstLower_22 = StringExtensions.toFirstLower(_name_193);
                _builder.append(_firstLower_22, "\t");
                _builder.append("StringToInt(QString ");
                String _name_194 = this._cppExtensions.toName(feature_8);
                String _firstLower_23 = StringExtensions.toFirstLower(_name_194);
                ...
                _builder.append(" m");
                String _name_195 = this._cppExtensions.toName(feature_8);
      ...
      for(final LFeature feature_9 : _filter_15) {
        {
          ...
          if (_isLazyArray_1) {
            ...
            String _name_196 = this._cppExtensions.toName(feature_9);
            String _firstUpper_72 = StringExtensions.toFirstUpper(_name_196);
            _builder.append(_firstUpper_72, "\t");
            _builder.append("Keys;");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("bool m");
            String _name_197 = this._cppExtensions.toName(feature_9);
            String _firstUpper_73 = StringExtensions.toFirstUpper(_name_197);
        ...
        }
        {
          ...
          if (_not_8) {
            {
              boolean _hasTargetOSPropertyName_7 = this._cppExtensions.hasTargetOSPropertyName(dto);
              if (_hasTargetOSPropertyName_7) {
                _builder.append("\t");
                _builder.append("QList<");
                String _typeName_57 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_57, "\t");
                _builder.append("*> m");
                String _name_198 = this._cppExtensions.toName(feature_9);
                ...
                _builder.append("\t");
                _builder.append("static void appendTo");
                String _name_199 = this._cppExtensions.toName(feature_9);
                ...
                _builder.append("> *");
                String _name_200 = this._cppExtensions.toName(feature_9);
                ...
                String _firstLower_24 = StringExtensions.toFirstLower(_typeName_61);
                _builder.append(_firstLower_24, "\t\t");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("static int ");
                String _name_201 = this._cppExtensions.toName(feature_9);
                _builder.append(_name_201, "\t");
                _builder.append("PropertyCount(QQmlListProperty<");
                String _typeName_62 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_62, "\t");
                _builder.append("> *");
                String _name_202 = this._cppExtensions.toName(feature_9);
                _builder.append(_name_202, "\t");
                _builder.append("List);");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("static ");
                String _typeName_63 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_63, "\t");
                _builder.append("* at");
                String _name_203 = this._cppExtensions.toName(feature_9);
                String _firstUpper_76 = StringExtensions.toFirstUpper(_name_203);
                _builder.append(_firstUpper_76, "\t");
                _builder.append("Property(QQmlListProperty<");
                String _typeName_64 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_64, "\t");
                _builder.append("> *");
                String _name_204 = this._cppExtensions.toName(feature_9);
                _builder.append(_name_204, "\t");
                _builder.append("List, int pos);");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("static void clear");
                String _name_205 = this._cppExtensions.toName(feature_9);
                String _firstUpper_77 = StringExtensions.toFirstUpper(_name_205);
                _builder.append(_firstUpper_77, "\t");
                _builder.append("Property(QQmlListProperty<");
                String _typeName_65 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_65, "\t");
                _builder.append("> *");
                String _name_206 = this._cppExtensions.toName(feature_9);
                ...
                _builder.append("\t");
                _builder.append("QList<");
                String _typeName_66 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_66, "\t");
                _builder.append("*> m");
                String _name_207 = this._cppExtensions.toName(feature_9);
                String _firstUpper_78 = StringExtensions.toFirstUpper(_name_207);
                ...
                _builder.append("\t");
                _builder.append("// QML functions for List of ");
                String _typeName_67 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_67, "\t");
                _builder.append("*");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("static void appendTo");
                String _name_208 = this._cppExtensions.toName(feature_9);
                String _firstUpper_79 = StringExtensions.toFirstUpper(_name_208);
                _builder.append(_firstUpper_79, "\t");
                _builder.append("Property(QDeclarativeListProperty<");
                String _typeName_68 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_68, "\t");
                _builder.append("> *");
                String _name_209 = this._cppExtensions.toName(feature_9);
                _builder.append(_name_209, "\t");
                _builder.append("List,");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("\t");
                String _typeName_69 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_69, "\t\t");
                _builder.append("* ");
                String _typeName_70 = this._cppExtensions.toTypeName(feature_9);
                String _firstLower_25 = StringExtensions.toFirstLower(_typeName_70);
                _builder.append(_firstLower_25, "\t\t");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("static int ");
                String _name_210 = this._cppExtensions.toName(feature_9);
                _builder.append(_name_210, "\t");
                _builder.append("PropertyCount(QDeclarativeListProperty<");
                String _typeName_71 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_71, "\t");
                _builder.append("> *");
                String _name_211 = this._cppExtensions.toName(feature_9);
                _builder.append(_name_211, "\t");
                _builder.append("List);");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("static ");
                String _typeName_72 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_72, "\t");
                _builder.append("* at");
                String _name_212 = this._cppExtensions.toName(feature_9);
                String _firstUpper_80 = StringExtensions.toFirstUpper(_name_212);
                _builder.append(_firstUpper_80, "\t");
                _builder.append("Property(QDeclarativeListProperty<");
                String _typeName_73 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_73, "\t");
                _builder.append("> *");
                String _name_213 = this._cppExtensions.toName(feature_9);
                _builder.append(_name_213, "\t");
                _builder.append("List, int pos);");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("static void clear");
                String _name_214 = this._cppExtensions.toName(feature_9);
                String _firstUpper_81 = StringExtensions.toFirstUpper(_name_214);
                _builder.append(_firstUpper_81, "\t");
                _builder.append("Property(QDeclarativeListProperty<");
                String _typeName_74 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_74, "\t");
                _builder.append("> *");
                String _name_215 = this._cppExtensions.toName(feature_9);
            ...
            {
              String _typeName_75 = this._cppExtensions.toTypeName(feature_9);
              boolean _equals_9 = Objects.equal(_typeName_75, "QString");
              if (_equals_9) {
                _builder.append("\t");
                _builder.append("QStringList m");
                String _name_216 = this._cppExtensions.toName(feature_9);
                String _firstUpper_82 = StringExtensions.toFirstUpper(_name_216);
                ...
                _builder.append("\t");
                _builder.append("QList<");
                String _typeName_76 = this._cppExtensions.toTypeName(feature_9);
                _builder.append(_typeName_76, "\t");
                _builder.append("> m");
                String _name_217 = this._cppExtensions.toName(feature_9);
                String _firstUpper_83 = StringExtensions.toFirstUpper(_name_217);
    ...
    String _firstUpper_84 = StringExtensions.toFirstUpper(_name_218);
    ...
    String _firstUpper_85 = StringExtensions.toFirstUpper(_name_219);
    ...
    String _upperCase_2 = _name_220.toUpperCase();
