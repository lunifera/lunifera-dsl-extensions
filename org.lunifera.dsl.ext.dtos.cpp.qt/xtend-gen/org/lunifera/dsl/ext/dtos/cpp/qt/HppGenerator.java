  ...
  public CharSequence toContent(final LDto dto) {
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_1 : _filter_8) {
        ...
        String _name_24 = this._cppExtensions.toName(feature_1);
    ...
    String _firstLower = StringExtensions.toFirstLower(_name_34);
      ...
      for(final LFeature feature_3 : _filter_10) {
        {
          ...
          if (_isLazy_1) {
            ...
            String _firstUpper_7 = StringExtensions.toFirstUpper(_name_39);
            ...
            String _firstUpper_12 = StringExtensions.toFirstUpper(_name_45);
            ...
            if (_isEnum_1) {
              ...
              String _firstUpper_15 = StringExtensions.toFirstUpper(_name_50);
          ...
          if (_not_1) {
            ...
            }
            {
              ...
              if (_and_2) {
                ...
                String _firstUpper_25 = StringExtensions.toFirstUpper(_referenceDomainKey_3);
          ...
          if (_not_2) {
          ...
          } else {
            {
              ...
              if (_equals_2) {
                ...
                String _firstUpper_31 = StringExtensions.toFirstUpper(_name_77);
                ...
                if (_and_3) {
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_isTypeOfDataObject_4) {
                      ...
                      String _firstLower_11 = StringExtensions.toFirstLower(_name_98);
          ...
          if (_not_3) {
            ...
            }
            {
              ...
              if (_and_4) {
                ...
                String _firstUpper_39 = StringExtensions.toFirstUpper(_referenceDomainKey_7);
          ...
          if (_and_5) {
            ...
            if (_isLazy_3) {
              ...
              if (_isEnum_3) {
                ...
                String _name_116 = this._cppExtensions.toName(feature_7);
                ...
                String _firstLower_15 = StringExtensions.toFirstLower(_name_117);
                _builder.append(_firstLower_15, "\t");
                _builder.append("StringToInt(QString ");
                String _name_118 = this._cppExtensions.toName(feature_7);
                String _firstLower_16 = StringExtensions.toFirstLower(_name_118);
                ...
                _builder.append(" m");
                String _name_119 = this._cppExtensions.toName(feature_7);
      ...
      for(final LFeature feature_8 : _filter_15) {
        {
          ...
          if (_not_4) {
            ...
            String _firstLower_17 = StringExtensions.toFirstLower(_typeName_45);
          ...
          } else {
            {
              ...
              if (_equals_4) {
                ...
                String _firstUpper_54 = StringExtensions.toFirstUpper(_name_129);
                ...
                String _firstUpper_55 = StringExtensions.toFirstUpper(_name_130);
    ...
    String _upperCase_2 = _name_133.toUpperCase();
