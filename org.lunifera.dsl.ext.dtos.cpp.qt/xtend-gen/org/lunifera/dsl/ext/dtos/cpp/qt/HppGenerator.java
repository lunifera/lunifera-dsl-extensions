      ...
      for(final LFeature feature_5 : _filter_12) {
        {
          ...
          if (_isLazy_2) {
            ...
            String _firstLower_16 = StringExtensions.toFirstLower(_typeName_41);
                ...
                if (_and_4) {
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_isTypeOfDataObject_4) {
                      _builder.append("\t");
                      _builder.append("void ");
                      String _name_122 = this._cppExtensions.toName(feature_5);
                      String _firstLower_17 = StringExtensions.toFirstLower(_name_122);
      ...
      for(final LFeature feature_6 : _filter_13) {
        {
          ...
          if (_not_7) {
            ...
            String _firstLower_18 = StringExtensions.toFirstLower(_typeName_44);
          ...
          } else {
            {
              ...
              if (_equals_6) {
                ...
                String _firstLower_19 = StringExtensions.toFirstLower(_typeName_49);
                ...
                String _firstLower_20 = StringExtensions.toFirstLower(_typeName_51);
            ...
            if (_isLazy_3) {
              ...
              _builder.newLineIfNotEmpty();
              {
                ...
                if (_isHierarchy_2) {
                  ...
                  String _firstLower_21 = StringExtensions.toFirstLower(_name_149);
              ...
              if (_isEnum_3) {
                ...
                String _firstLower_23 = StringExtensions.toFirstLower(_name_162);
                ...
                _builder.append(" m");
                String _name_163 = this._cppExtensions.toName(feature_7);
      ...
      for(final LFeature feature_8 : _filter_15) {
        ...
        }
        {
          ...
          if (_not_8) {
            ...
            String _firstLower_24 = StringExtensions.toFirstLower(_typeName_56);
