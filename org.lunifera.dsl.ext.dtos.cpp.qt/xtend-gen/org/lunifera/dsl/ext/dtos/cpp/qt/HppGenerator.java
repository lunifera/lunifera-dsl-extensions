...
public class HppGenerator {
  ...
  public CharSequence toContent(final LDto dto) {
          ...
          if (_isLazy_2) {
          ...
          } else {
            {
              ...
              if (_and_2) {
                ...
                _builder.append(" ");
                String _name_66 = this._cppExtensions.toName(feature_5);
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_isTypeOfDTO_4) {
                    _builder.append("\t");
                    _builder.append("void ");
                    String _name_67 = this._cppExtensions.toName(feature_5);
                    String _firstLower_7 = StringExtensions.toFirstLower(_name_67);
      ...
      for(final LFeature feature_6 : _filter_9) {
        {
          ...
          if (_notEquals_4) {
            ...
            String _firstUpper_21 = StringExtensions.toFirstUpper(_name_70);
            ...
            String _firstUpper_22 = StringExtensions.toFirstUpper(_name_71);
            ...
            String _firstUpper_23 = StringExtensions.toFirstUpper(_name_74);
            ...
            String _firstUpper_24 = StringExtensions.toFirstUpper(_name_75);
          ...
          for(final LFeature feature_7 : _filter_10) {
            {
              ...
              if (_isLazy_3) {
                ...
                String _firstUpper_25 = StringExtensions.toFirstUpper(_name_76);
    ...
    String _firstUpper_26 = StringExtensions.toFirstUpper(_name_77);
      ...
      for(final LFeature feature_9 : _filter_12) {
        {
          ...
          if (_notEquals_5) {
            ...
            String _firstUpper_34 = StringExtensions.toFirstUpper(_name_89);
    ...
    String _upperCase_2 = _name_94.toUpperCase();
