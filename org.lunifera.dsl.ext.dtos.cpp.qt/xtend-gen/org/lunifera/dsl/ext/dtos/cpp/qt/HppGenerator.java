  ...
  public CharSequence toContent(final LDto dto) {
    ...
    }
    {
      ...
      for(final LFeature feature_2 : _filter_5) {
        {
          String _typeName_4 = this._cppExtensions.toTypeName(feature_2);
          boolean _equals = Objects.equal(_typeName_4, "QString");
          if (_equals) {
            _builder.append("\t");
      ...
      for(final LFeature feature_3 : _filter_6) {
        {
          ...
          if (_isLazy_1) {
            ...
            String _firstUpper_6 = StringExtensions.toFirstUpper(_name_34);
            ...
            String _firstUpper_7 = StringExtensions.toFirstUpper(_name_35);
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_and_1) {
                ...
                String _firstUpper_9 = StringExtensions.toFirstUpper(_name_39);
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_isTypeOfDTO_2) {
                    ...
                    String _firstUpper_10 = StringExtensions.toFirstUpper(_name_41);
                    ...
                    String _firstUpper_11 = StringExtensions.toFirstUpper(_name_42);
      ...
      for(final LFeature feature_4 : _filter_7) {
        {
          ...
          if (_not_1) {
            ...
            String _firstUpper_13 = StringExtensions.toFirstUpper(_name_45);
            ...
            String _firstUpper_14 = StringExtensions.toFirstUpper(_name_46);
          ...
          } else {
            {
              ...
              if (_equals_1) {
                ...
                String _firstLower_4 = StringExtensions.toFirstLower(_typeName_13);
                ...
                String _firstUpper_19 = StringExtensions.toFirstUpper(_typeName_17);
                ...
                String _firstUpper_21 = StringExtensions.toFirstUpper(_typeName_19);
        ...
        _builder.newLine();
        {
          ...
          if (_not_2) {
            ...
            String _firstUpper_22 = StringExtensions.toFirstUpper(_name_55);
      ...
      for(final LFeature feature_5 : _filter_8) {
        {
          ...
          if (_isLazy_2) {
            _builder.append("\t");
            _builder.append("// ");
            String _name_71 = this._cppExtensions.toName(feature_5);
            ...
            String _name_72 = this._cppExtensions.toName(feature_5);
            ...
            _builder.append(" ");
            String _name_73 = this._cppExtensions.toName(feature_5);
            _builder.append(_name_73, "\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("void ");
            String _name_74 = this._cppExtensions.toName(feature_5);
            ...
            _builder.append(" ");
            String _name_75 = this._cppExtensions.toName(feature_5);
            _builder.append(_name_75, "\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("void request");
            String _name_76 = this._cppExtensions.toName(feature_5);
            ...
            _builder.append(" ");
            String _name_77 = this._cppExtensions.toName(feature_5);
          ...
          } else {
            {
              ...
              if (_and_2) {
                ...
                String _name_78 = this._cppExtensions.toName(feature_5);
                ...
                _builder.append("\t");
                _builder.append("void ");
                String _name_79 = this._cppExtensions.toName(feature_5);
                ...
                _builder.append(" ");
                String _name_80 = this._cppExtensions.toName(feature_5);
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_isTypeOfDTO_4) {
                    _builder.append("\t");
                    _builder.append("void ");
                    String _name_81 = this._cppExtensions.toName(feature_5);
                    String _firstLower_7 = StringExtensions.toFirstLower(_name_81);
      ...
      for(final LFeature feature_6 : _filter_9) {
        {
          ...
          if (_not_3) {
            _builder.append("\t");
            _builder.append("void ");
            String _name_82 = this._cppExtensions.toName(feature_6);
            _builder.append(_name_82, "\t");
            _builder.append("Changed(QList<");
            String _typeName_27 = this._cppExtensions.toTypeName(feature_6);
            _builder.append(_typeName_27, "\t");
            _builder.append("*> ");
            String _name_83 = this._cppExtensions.toName(feature_6);
            _builder.append(_name_83, "\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("void addedTo");
            String _name_84 = this._cppExtensions.toName(feature_6);
            String _firstUpper_28 = StringExtensions.toFirstUpper(_name_84);
            _builder.append(_firstUpper_28, "\t");
            _builder.append("(");
            String _typeName_28 = this._cppExtensions.toTypeName(feature_6);
            _builder.append(_typeName_28, "\t");
            _builder.append("* ");
            String _typeName_29 = this._cppExtensions.toTypeName(feature_6);
            String _firstLower_8 = StringExtensions.toFirstLower(_typeName_29);
            _builder.append(_firstLower_8, "\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("void removedFrom");
            String _name_85 = this._cppExtensions.toName(feature_6);
          ...
          } else {
            {
              ...
              boolean _equals_3 = Objects.equal(_typeName_30, "QString");
              if (_equals_3) {
                _builder.append("\t");
                _builder.append("void ");
                String _name_86 = this._cppExtensions.toName(feature_6);
                _builder.append(_name_86, "\t");
                _builder.append("StringListChanged(QStringList ");
                String _name_87 = this._cppExtensions.toName(feature_6);
                _builder.append(_name_87, "\t");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("void addedTo");
                String _name_88 = this._cppExtensions.toName(feature_6);
                String _firstUpper_30 = StringExtensions.toFirstUpper(_name_88);
                ...
                String _firstLower_9 = StringExtensions.toFirstLower(_typeName_32);
                _builder.append(_firstLower_9, "\t");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("void removedFrom");
                String _name_89 = this._cppExtensions.toName(feature_6);
                String _firstUpper_31 = StringExtensions.toFirstUpper(_name_89);
                ...
                String _firstLower_10 = StringExtensions.toFirstLower(_typeName_34);
                ...
                _builder.append("\t");
                _builder.append("void ");
                String _name_90 = this._cppExtensions.toName(feature_6);
                _builder.append(_name_90, "\t");
                _builder.append("ListChanged(QVariantList ");
                String _name_91 = this._cppExtensions.toName(feature_6);
                _builder.append(_name_91, "\t");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("void addedTo");
                String _name_92 = this._cppExtensions.toName(feature_6);
                ...
                String _firstUpper_33 = StringExtensions.toFirstUpper(_typeName_36);
                _builder.append(_firstUpper_33, "\t");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("void removedFrom");
                String _name_93 = this._cppExtensions.toName(feature_6);
                ...
                String _firstUpper_35 = StringExtensions.toFirstUpper(_typeName_38);
          ...
          for(final LFeature feature_7 : _filter_10) {
            {
              ...
              if (_isLazy_3) {
                ...
                String _firstUpper_36 = StringExtensions.toFirstUpper(_name_94);
                ...
                _builder.append(" ");
                String _typeName_39 = this._cppExtensions.toTypeName(feature_7);
                String _firstLower_11 = StringExtensions.toFirstLower(_typeName_39);
    ...
    String _firstUpper_37 = StringExtensions.toFirstUpper(_name_95);
      ...
      for(final LFeature feature_8 : _filter_11) {
        {
          ...
          if (_and_3) {
            ...
            String _firstUpper_38 = StringExtensions.toFirstUpper(_name_96);
            ...
            if (_isLazy_4) {
              ...
              String _firstUpper_39 = StringExtensions.toFirstUpper(_name_97);
              ...
              String _firstUpper_40 = StringExtensions.toFirstUpper(_name_98);
      ...
      for(final LFeature feature_9 : _filter_12) {
        {
          ...
          if (_not_4) {
            _builder.append("\t");
            _builder.append("QList<");
            String _typeName_40 = this._cppExtensions.toTypeName(feature_9);
            ...
            String _typeName_41 = this._cppExtensions.toTypeName(feature_9);
            ...
            String _firstUpper_43 = StringExtensions.toFirstUpper(_name_101);
            _builder.append(_firstUpper_43, "\t");
            _builder.append("Property(QDeclarativeListProperty<");
            String _typeName_42 = this._cppExtensions.toTypeName(feature_9);
            ...
            _builder.append("\t");
            _builder.append("\t");
            String _typeName_43 = this._cppExtensions.toTypeName(feature_9);
            _builder.append(_typeName_43, "\t\t");
            _builder.append("* ");
            String _typeName_44 = this._cppExtensions.toTypeName(feature_9);
            String _firstLower_12 = StringExtensions.toFirstLower(_typeName_44);
            ...
            String _typeName_45 = this._cppExtensions.toTypeName(feature_9);
            ...
            String _typeName_46 = this._cppExtensions.toTypeName(feature_9);
            _builder.append(_typeName_46, "\t");
            _builder.append("* at");
            String _name_105 = this._cppExtensions.toName(feature_9);
            String _firstUpper_44 = StringExtensions.toFirstUpper(_name_105);
            _builder.append(_firstUpper_44, "\t");
            _builder.append("Property(QDeclarativeListProperty<");
            String _typeName_47 = this._cppExtensions.toTypeName(feature_9);
            ...
            _builder.append("Property(QDeclarativeListProperty<");
            String _typeName_48 = this._cppExtensions.toTypeName(feature_9);
            ...
            {
              String _typeName_49 = this._cppExtensions.toTypeName(feature_9);
              boolean _equals_4 = Objects.equal(_typeName_49, "QString");
              if (_equals_4) {
                _builder.append("\t");
                ...
                _builder.append("\t");
                _builder.append("QList<");
                String _typeName_50 = this._cppExtensions.toTypeName(feature_9);
    ...
    String _firstUpper_49 = StringExtensions.toFirstUpper(_name_112);
    ...
    String _upperCase_2 = _name_113.toUpperCase();
