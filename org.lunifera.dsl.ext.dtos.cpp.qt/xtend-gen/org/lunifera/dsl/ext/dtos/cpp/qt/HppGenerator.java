...
public class HppGenerator {
  ...
  public CharSequence toContent(final LDto dto) {
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature : _filter_1) {
        {
          boolean _and = false;
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_1 : _filter_2) {
        _builder.append("\t");
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_2 : _filter_3) {
        {
          ...
          if (_isLazy_1) {
            ...
            String _firstUpper_4 = StringExtensions.toFirstUpper(_name_26);
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_and_1) {
                ...
                String _firstUpper_7 = StringExtensions.toFirstUpper(_name_31);
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_isTypeOfDTO_2) {
                    ...
                    String _firstUpper_8 = StringExtensions.toFirstUpper(_name_33);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_3 : _filter_4) {
        _builder.append("\t");
        _builder.append("Q_INVOKABLE");
        _builder.newLine();
        _builder.append("\t");
        ...
        String _firstLower_1 = StringExtensions.toFirstLower(_typeName_5);
        ...
        String _firstLower_2 = StringExtensions.toFirstLower(_typeName_7);
        ...
        String _firstLower_3 = StringExtensions.toFirstLower(_typeName_8);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_4 : _filter_5) {
        {
    ...
    }
    {
      ...
      for(final LFeature feature_5 : _filter_6) {
        _builder.append("\t");
        _builder.append("void ");
        ...
        String _firstUpper_17 = StringExtensions.toFirstUpper(_name_59);
    ...
    _builder.newLine();
    {
      ...
      if (_existsLazy) {
        ...
        _builder.newLine();
        {
          ...
          for(final LFeature feature_6 : _filter_7) {
            {
              ...
              if (_isLazy_3) {
                ...
                String _firstLower_7 = StringExtensions.toFirstLower(_typeName_15);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_7 : _filter_8) {
        {
          ...
          if (_and_3) {
            ...
            if (_isLazy_4) {
              ...
              String _firstUpper_22 = StringExtensions.toFirstUpper(_name_64);
    ...
    }
    {
      ...
      for(final LFeature feature_8 : _filter_9) {
        _builder.append("\t");
        _builder.append("QList<");
        ...
        String _firstLower_8 = StringExtensions.toFirstLower(_typeName_20);
    ...
    String _firstUpper_29 = StringExtensions.toFirstUpper(_name_76);
    ...
    String _upperCase_2 = _name_78.toUpperCase();
