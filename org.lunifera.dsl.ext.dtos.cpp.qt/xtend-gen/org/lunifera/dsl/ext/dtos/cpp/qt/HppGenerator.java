  ...
  public CharSequence toContent(final LDto dto) {
      ...
      for(final LFeature feature : _filter_7) {
        {
          ...
          if (_and) {
            ...
            if (_isLazy) {
              ...
              _builder.append("AsDataObject WRITE set");
      ...
      for(final LFeature feature_3 : _filter_10) {
        {
          ...
          if (_isLazy_1) {
            ...
            String _firstUpper_11 = StringExtensions.toFirstUpper(_name_41);
            ...
            String _firstUpper_12 = StringExtensions.toFirstUpper(_name_42);
            ...
            if (_isEnum_1) {
              ...
              String _firstUpper_13 = StringExtensions.toFirstUpper(_name_44);
              ...
              }
              {
                ...
                if (_and_1) {
                  ...
                  String _firstUpper_16 = StringExtensions.toFirstUpper(_name_51);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_4 : _filter_11) {
          ...
          if (_not_1) {
            ...
            _builder.newLine();
            {
              ...
              if (_equals_1) {
                ...
                String _firstUpper_26 = StringExtensions.toFirstUpper(_typeName_21);
                ...
                String _firstUpper_27 = StringExtensions.toFirstUpper(_name_63);
                ...
                String _firstUpper_28 = StringExtensions.toFirstUpper(_typeName_23);
        ...
        String _firstLower_7 = StringExtensions.toFirstLower(_name_64);
        ...
        _builder.newLine();
        {
          ...
          if (_not_2) {
          ...
          } else {
            {
              ...
              boolean _equals_2 = Objects.equal(_typeName_27, "QString");
              if (_equals_2) {
                _builder.append("\t");
                ...
                String _firstUpper_30 = StringExtensions.toFirstUpper(_name_72);
                ...
                String _firstUpper_31 = StringExtensions.toFirstUpper(_name_76);
                ...
                if (_and_2) {
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_isTypeOfDataObject_4) {
                      ...
                      String _firstLower_8 = StringExtensions.toFirstLower(_name_95);
          ...
          if (_not_3) {
          ...
          } else {
            {
              ...
              if (_equals_3) {
                ...
                String _firstLower_11 = StringExtensions.toFirstLower(_typeName_38);
                ...
                String _firstUpper_40 = StringExtensions.toFirstUpper(_typeName_40);
                ...
                String _firstUpper_42 = StringExtensions.toFirstUpper(_typeName_42);
          ...
          for(final LFeature feature_7 : _filter_14) {
            {
              ...
              if (_isLazy_3) {
                ...
                String _firstLower_12 = StringExtensions.toFirstLower(_typeName_43);
      ...
      for(final LFeature feature_8 : _filter_15) {
        {
          ...
          if (_and_3) {
            ...
            if (_isLazy_4) {
              ...
              String _firstUpper_47 = StringExtensions.toFirstUpper(_name_112);
              ...
              if (_isEnum_3) {
                ...
                String _firstLower_14 = StringExtensions.toFirstLower(_name_115);
                ...
                String _firstUpper_49 = StringExtensions.toFirstUpper(_name_116);
      ...
      for(final LFeature feature_9 : _filter_16) {
        {
          ...
          if (_not_4) {
            ...
            String _firstUpper_50 = StringExtensions.toFirstUpper(_name_117);
            ...
            String _firstUpper_51 = StringExtensions.toFirstUpper(_name_118);
            ...
            String _firstLower_15 = StringExtensions.toFirstLower(_typeName_48);
    ...
    String _firstUpper_56 = StringExtensions.toFirstUpper(_name_128);
    ...
    String _firstUpper_57 = StringExtensions.toFirstUpper(_name_129);
    ...
    String _upperCase_2 = _name_130.toUpperCase();
