  ...
  public CharSequence toContent(final LDto dto) {
      ...
      for(final LFeature feature_3 : _filter_10) {
        {
          ...
          if (_isLazy_1) {
            ...
            if (_isEnum_1) {
              ...
              String _firstUpper_13 = StringExtensions.toFirstUpper(_name_47);
              ...
              String _firstUpper_14 = StringExtensions.toFirstUpper(_name_49);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_4 : _filter_11) {
        ...
        String _firstLower_9 = StringExtensions.toFirstLower(_name_68);
        ...
        _builder.newLine();
        {
          ...
          if (_not_2) {
            ...
            String _firstUpper_29 = StringExtensions.toFirstUpper(_name_71);
                ...
                if (_and_3) {
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_isTypeOfDataObject_4) {
                      ...
                      String _firstLower_11 = StringExtensions.toFirstLower(_name_97);
          ...
          if (_and_5) {
            ...
            if (_isLazy_3) {
              ...
              if (_isEnum_3) {
                ...
                String _firstUpper_47 = StringExtensions.toFirstUpper(_name_117);
      ...
      for(final LFeature feature_8 : _filter_15) {
        {
          ...
          if (_not_4) {
            ...
            String _firstUpper_51 = StringExtensions.toFirstUpper(_name_125);
          ...
          } else {
            {
              ...
              if (_equals_4) {
                ...
                String _firstUpper_52 = StringExtensions.toFirstUpper(_name_127);
                ...
                String _firstUpper_53 = StringExtensions.toFirstUpper(_name_128);
