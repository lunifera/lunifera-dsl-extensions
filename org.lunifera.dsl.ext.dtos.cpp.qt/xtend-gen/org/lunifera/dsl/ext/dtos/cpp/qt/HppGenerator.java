...
public class HppGenerator {
  ...
  public CharSequence toContent(final LDto dto) {
      ...
      for(final LFeature feature_2 : _filter_2) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          if (_and_1) {
            ...
            String _name_16 = this._cppExtensions.toName(feature_2);
            ...
            String _name_17 = this._cppExtensions.toName(feature_2);
            String _firstUpper_3 = StringExtensions.toFirstUpper(_name_17);
            _builder.append(_firstUpper_3, "\t");
            _builder.append("(");
            String _typeOrQObject_3 = this._cppExtensions.toTypeOrQObject(feature_2);
            _builder.append(_typeOrQObject_3, "\t");
            _builder.append(" ");
            String _name_18 = this._cppExtensions.toName(feature_2);
      ...
      for(final LFeature feature_4 : _filter_4) {
        {
          ...
          if (_and_2) {
            ...
            String _typeOrQObject_4 = this._cppExtensions.toTypeOrQObject(feature_4);
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_isTypeOfDTO_4) {
                ...
                String _firstLower_5 = StringExtensions.toFirstLower(_name_34);
      ...
      for(final LFeature feature_6 : _filter_6) {
        {
          ...
          boolean _isTypeOfDTO_5 = this._cppExtensions.isTypeOfDTO(feature_6);
          if (!_isTypeOfDTO_5) {
            _and_3 = false;
          } else {
          ...
          if (_and_3) {
            ...
            _builder.append("\t");
            String _typeOrQObject_5 = this._cppExtensions.toTypeOrQObject(feature_6);
    ...
    String _firstUpper_18 = StringExtensions.toFirstUpper(_name_43);
    ...
    String _firstUpper_19 = StringExtensions.toFirstUpper(_name_44);
    ...
    String _upperCase_2 = _name_45.toUpperCase();
