...
public class HppGenerator {
  ...
  public CharSequence toContent(final LDto dto) {
      ...
      for(final LFeature feature_4 : _filter_11) {
        {
          ...
          if (_not_1) {
            ...
            String _firstLower_6 = StringExtensions.toFirstLower(_typeName_16);
            ...
            String _firstLower_7 = StringExtensions.toFirstLower(_typeName_17);
            ...
            }
            {
              ...
              if (_and_2) {
                ...
                String _firstUpper_31 = StringExtensions.toFirstUpper(_referenceDomainKey_3);
            ...
            _builder.newLine();
            {
              ...
              boolean _equals_1 = Objects.equal(_typeName_18, "QString");
              if (_equals_1) {
                _builder.append("\t");
                _builder.append("Q_INVOKABLE");
                _builder.newLine();
        ...
        String _firstLower_10 = StringExtensions.toFirstLower(_name_83);
        ...
        _builder.newLine();
        {
          ...
          if (_not_2) {
          ...
          } else {
            {
              ...
              boolean _equals_2 = Objects.equal(_typeName_28, "QString");
              if (_equals_2) {
                _builder.append("\t");
                ...
                String _firstUpper_38 = StringExtensions.toFirstUpper(_name_95);
                ...
                String _firstUpper_39 = StringExtensions.toFirstUpper(_name_99);
      ...
      for(final LFeature feature_5 : _filter_12) {
        {
          ...
          if (_isLazy_2) {
            ...
            String _typeName_32 = this._cppExtensions.toTypeName(feature_5);
            _builder.append(_typeName_32, "\t");
            _builder.append("* ");
            String _typeName_33 = this._cppExtensions.toTypeName(feature_5);
            String _firstLower_11 = StringExtensions.toFirstLower(_typeName_33);
                ...
                if (_and_3) {
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_isTypeOfDataObject_4) {
                      ...
                      String _firstLower_12 = StringExtensions.toFirstLower(_name_112);
          ...
          if (_not_3) {
            ...
            }
            {
              ...
              if (_and_4) {
                ...
                String _firstUpper_45 = StringExtensions.toFirstUpper(_referenceDomainKey_7);
          ...
          } else {
            {
              ...
              boolean _equals_3 = Objects.equal(_typeName_37, "QString");
              if (_equals_3) {
                _builder.append("\t");
                _builder.append("void ");
                ...
                String _firstLower_15 = StringExtensions.toFirstLower(_typeName_43);
            ...
            if (_isLazy_3) {
              ...
              _builder.newLineIfNotEmpty();
              {
                ...
                if (_isHierarchy_2) {
                  ...
                  String _firstLower_16 = StringExtensions.toFirstLower(_name_139);
                  ...
                  String _firstUpper_57 = StringExtensions.toFirstUpper(_name_144);
                  ...
                  String _firstUpper_58 = StringExtensions.toFirstUpper(_name_147);
              ...
              if (_isEnum_3) {
                ...
                String _firstUpper_59 = StringExtensions.toFirstUpper(_name_150);
                ...
                String _firstLower_17 = StringExtensions.toFirstLower(_name_151);
                _builder.append(_firstLower_17, "\t");
                _builder.append("StringToInt(QString ");
                String _name_152 = this._cppExtensions.toName(feature_7);
                String _firstLower_18 = StringExtensions.toFirstLower(_name_152);
      ...
      for(final LFeature feature_8 : _filter_15) {
        {
          ...
          if (_not_4) {
            ...
            String _firstLower_19 = StringExtensions.toFirstLower(_typeName_48);
          ...
          } else {
            {
              ...
              boolean _equals_4 = Objects.equal(_typeName_53, "QString");
              if (_equals_4) {
                _builder.append("\t");
    ...
    String _upperCase_2 = _name_167.toUpperCase();
