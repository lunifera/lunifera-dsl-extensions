  ...
  public CharSequence toContent(final LDto dto) {
      ...
      for(final LFeature feature_7 : _filter_5) {
        {
          ...
          if (_isToMany) {
            ...
            if (_isLazy_1) {
              ...
              String _validateReference = this._cppExtensions.toValidateReference(_typeName_11, _name_68);
              ...
              if (_isTypeOfDTO_3) {
                ...
                String _firstUpper_29 = StringExtensions.toFirstUpper(_name_69);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_8 : _filter_6) {
        ...
        String _firstUpper_30 = StringExtensions.toFirstUpper(_name_73);
      ...
      for(final LFeature feature_9 : _filter_7) {
        {
          ...
          if (_isTypeOfDTO_4) {
              ...
              if (_not) {
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_isToMany_1) {
                    ...
                    String _firstUpper_35 = StringExtensions.toFirstUpper(_name_81);
                    ...
                    String _firstUpper_36 = StringExtensions.toFirstUpper(_name_83);
                ...
                String _firstUpper_37 = StringExtensions.toFirstUpper(_name_84);
          ...
          } else {
            {
              ...
              boolean _isToMany_2 = this._cppExtensions.isToMany(feature_9);
              if (!_isToMany_2) {
                _and_2 = false;
              } else {
              ...
              if (_and_2) {
                ...
                String _firstUpper_38 = StringExtensions.toFirstUpper(_name_86);
              ...
              if (_isTypeOfDTO_5) {
                {
                  ...
                  if (_not_1) {
                    ...
                    _builder.newLineIfNotEmpty();
                    {
                      boolean _isToMany_3 = this._cppExtensions.isToMany(feature_11);
                      if (_isToMany_3) {
                        _builder.append("\t");
                        _builder.append("foreignMap.insert(");
              ...
              } else {
                {
                  ...
                  boolean _isToMany_4 = this._cppExtensions.isToMany(feature_11);
                  if (!_isToMany_4) {
                    _and_3 = false;
                  } else {
                    String _typeName_17 = this._cppExtensions.toTypeName(feature_11);
                    boolean _equals_2 = Objects.equal(_typeName_17, "QString");
                    _and_3 = _equals_2;
                  }
                  if (_and_3) {
                    _builder.append("\t");
                    ...
                    String _firstUpper_48 = StringExtensions.toFirstUpper(_name_107);
          ...
          if (_isTypeOfDTO_6) {
            {
              ...
              if (_not_2) {
                ...
                _builder.newLineIfNotEmpty();
                {
                  boolean _isToMany_5 = this._cppExtensions.isToMany(feature_13);
                  if (_isToMany_5) {
                    _builder.append("\t");
                    _builder.append("persistMap.insert(");
                    String _name_116 = this._cppExtensions.toName(feature_13);
                    _builder.append(_name_116, "\t");
                    _builder.append("Key, ");
                    String _name_117 = this._cppExtensions.toName(feature_13);
                    ...
                    _builder.append("\t");
                    _builder.append("if(m");
                    String _name_118 = this._cppExtensions.toName(feature_13);
                    String _firstUpper_52 = StringExtensions.toFirstUpper(_name_118);
                    ...
                    _builder.append("\t");
                    _builder.append("persistMap.insert(");
                    String _name_119 = this._cppExtensions.toName(feature_13);
                    _builder.append(_name_119, "\t\t");
                    _builder.append("Key, m");
                    String _name_120 = this._cppExtensions.toName(feature_13);
                    String _firstUpper_53 = StringExtensions.toFirstUpper(_name_120);
                ...
                _builder.append("\t");
                _builder.append("// m");
                String _name_121 = this._cppExtensions.toName(feature_13);
                String _firstUpper_54 = StringExtensions.toFirstUpper(_name_121);
          ...
          } else {
            {
              ...
              boolean _isToMany_6 = this._cppExtensions.isToMany(feature_13);
              if (!_isToMany_6) {
                _and_4 = false;
              } else {
              ...
              if (_and_4) {
                _builder.append("\t");
                _builder.append("persistMap.insert(");
                String _name_123 = this._cppExtensions.toName(feature_13);
                _builder.append(_name_123, "\t");
                _builder.append("Key, m");
                String _name_124 = this._cppExtensions.toName(feature_13);
                String _firstUpper_55 = StringExtensions.toFirstUpper(_name_124);
                ...
                String _firstUpper_56 = StringExtensions.toFirstUpper(_name_126);
    ...
    }
    {
      ...
      for(final LFeature feature_14 : _filter_12) {
        ...
        String _firstUpper_57 = StringExtensions.toFirstUpper(_name_127);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_15 : _filter_13) {
        ...
        String _firstUpper_58 = StringExtensions.toFirstUpper(_name_131);
        ...
        String _firstUpper_60 = StringExtensions.toFirstUpper(_name_136);
        ...
        String _firstUpper_61 = StringExtensions.toFirstUpper(_name_139);
        ...
        String _firstUpper_62 = StringExtensions.toFirstUpper(_name_141);
        ...
        String _firstUpper_66 = StringExtensions.toFirstUpper(_name_151);
        ...
        String _firstUpper_67 = StringExtensions.toFirstUpper(_name_152);
        ...
        String _firstUpper_68 = StringExtensions.toFirstUpper(_name_154);
        ...
        String _firstUpper_70 = StringExtensions.toFirstUpper(_name_157);
        ...
        String _firstUpper_72 = StringExtensions.toFirstUpper(_name_160);
        ...
        _builder.append(" ");
        String _typeName_21 = this._cppExtensions.toTypeName(feature_15);
        ...
        String _firstLower_17 = StringExtensions.toFirstLower(_typeName_22);
        ...
        String _firstLower_18 = StringExtensions.toFirstLower(_typeName_23);
        ...
        String _firstUpper_73 = StringExtensions.toFirstUpper(_name_161);
        ...
        String _firstUpper_74 = StringExtensions.toFirstUpper(_name_162);
        _builder.append(_firstUpper_74, "            ");
        _builder.append("AsDTO = ");
        String _typeName_24 = this._cppExtensions.toTypeName(feature_15);
        String _firstLower_19 = StringExtensions.toFirstLower(_typeName_24);
      ...
      for(final LFeature feature_16 : _filter_14) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          if (_and_5) {
            ...
            String _firstUpper_76 = StringExtensions.toFirstUpper(_name_168);
            ...
            String _firstUpper_77 = StringExtensions.toFirstUpper(_name_170);
            ...
            String _firstUpper_78 = StringExtensions.toFirstUpper(_name_173);
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_isTypeOfDTO_8) {
                ...
                String _firstUpper_79 = StringExtensions.toFirstUpper(_name_174);
                ...
                String _firstUpper_82 = StringExtensions.toFirstUpper(_name_178);
            ...
            _builder.newLine();
            {
              ...
              if (_isTypeOfDTO_9) {
                ...
                String _firstUpper_84 = StringExtensions.toFirstUpper(_name_184);
                ...
                String _firstUpper_85 = StringExtensions.toFirstUpper(_name_185);
                ...
                String _firstLower_20 = StringExtensions.toFirstLower(_name_186);
                _builder.append(_firstLower_20, "\t\t");
                _builder.append("Deleted(m");
                String _name_187 = this._cppExtensions.toName(feature_16);
                String _firstUpper_86 = StringExtensions.toFirstUpper(_name_187);
                ...
                String _firstUpper_87 = StringExtensions.toFirstUpper(_name_188);
                ...
                String _firstUpper_88 = StringExtensions.toFirstUpper(_name_189);
                ...
                String _firstUpper_89 = StringExtensions.toFirstUpper(_name_191);
                ...
                String _firstUpper_90 = StringExtensions.toFirstUpper(_name_192);
    ...
    }
    {
      ...
      for(final LFeature feature_17 : _filter_15) {
        ...
        String _firstUpper_93 = StringExtensions.toFirstUpper(_name_196);
        ...
        String _firstLower_24 = StringExtensions.toFirstLower(_typeName_30);
        ...
        String _firstUpper_96 = StringExtensions.toFirstUpper(_name_200);
        ...
        String _firstLower_25 = StringExtensions.toFirstLower(_typeName_31);
        ...
        String _firstUpper_97 = StringExtensions.toFirstUpper(_name_201);
        ...
        String _firstUpper_98 = StringExtensions.toFirstUpper(_name_202);
        ...
        String _firstLower_27 = StringExtensions.toFirstLower(_name_203);
        ...
        String _firstLower_28 = StringExtensions.toFirstLower(_name_205);
        ...
        String _firstUpper_99 = StringExtensions.toFirstUpper(_name_206);
        ...
        String _firstUpper_100 = StringExtensions.toFirstUpper(_name_209);
        ...
        String _firstUpper_103 = StringExtensions.toFirstUpper(_name_215);
    ...
    }
    {
      ...
      for(final LFeature feature_18 : _filter_16) {
        ...
        _builder.append("::");
        String _name_220 = this._cppExtensions.toName(feature_18);
        ...
        String _firstUpper_107 = StringExtensions.toFirstUpper(_name_228);
        _builder.append(_firstUpper_107, "    ");
        _builder.append(".append(");
        String _typeName_36 = this._cppExtensions.toTypeName(feature_18);
        String _firstLower_30 = StringExtensions.toFirstLower(_typeName_36);
        ...
        String _firstUpper_108 = StringExtensions.toFirstUpper(_name_229);
        _builder.append(_firstUpper_108, "    ");
        _builder.append("(");
        String _typeName_37 = this._cppExtensions.toTypeName(feature_18);
        String _firstLower_31 = StringExtensions.toFirstLower(_typeName_37);
        ...
        String _firstUpper_109 = StringExtensions.toFirstUpper(_name_231);
        ...
        String _firstUpper_110 = StringExtensions.toFirstUpper(_name_232);
        ...
        String _firstUpper_111 = StringExtensions.toFirstUpper(_name_233);
        ...
        String _firstUpper_112 = StringExtensions.toFirstUpper(_name_234);
        ...
        String _firstUpper_113 = StringExtensions.toFirstUpper(_name_235);
        ...
        _builder.newLineIfNotEmpty();
        {
          boolean _hasOpposite = this._cppExtensions.hasOpposite(feature_18);
          if (_hasOpposite) {
            _builder.append("            ");
            _builder.append("// ");
            ...
            String _firstLower_35 = StringExtensions.toFirstLower(_typeName_42);
        ...
        String _firstLower_36 = StringExtensions.toFirstLower(_name_238);
        ...
        String _firstUpper_114 = StringExtensions.toFirstUpper(_name_240);
        ...
        String _firstLower_37 = StringExtensions.toFirstLower(_typeName_44);
        ...
        _builder.append(" = new ");
        String _typeName_47 = this._cppExtensions.toTypeName(feature_18);
        _builder.append(_typeName_47, "    ");
        _builder.append("();");
        _builder.newLineIfNotEmpty();
        _builder.append("    ");
        String _typeName_48 = this._cppExtensions.toTypeName(feature_18);
        String _firstLower_39 = StringExtensions.toFirstLower(_typeName_48);
        _builder.append(_firstLower_39, "    ");
        _builder.append("->setParent(this);");
        _builder.newLineIfNotEmpty();
        _builder.append("    ");
        String _typeName_49 = this._cppExtensions.toTypeName(feature_18);
        ...
        String _firstUpper_115 = StringExtensions.toFirstUpper(_name_241);
        ...
        String _firstUpper_116 = StringExtensions.toFirstUpper(_name_242);
        _builder.append(_firstUpper_116, "    ");
        _builder.append("(");
        String _typeName_52 = this._cppExtensions.toTypeName(feature_18);
        String _firstLower_43 = StringExtensions.toFirstLower(_typeName_52);
        ...
        String _firstUpper_117 = StringExtensions.toFirstUpper(_name_244);
        ...
        String _firstUpper_118 = StringExtensions.toFirstUpper(_name_245);
        ...
        String _firstUpper_119 = StringExtensions.toFirstUpper(_name_246);
        _builder.append(_firstUpper_119, "        ");
        _builder.append(".at(i))->toMap().value(uuidKey).toString() == uuid) {");
        _builder.newLineIfNotEmpty();
        {
          boolean _hasOpposite_1 = this._cppExtensions.hasOpposite(feature_18);
          if (_hasOpposite_1) {
            _builder.append("            ");
            String _typeName_53 = this._cppExtensions.toTypeName(feature_18);
            _builder.append(_typeName_53, "            ");
            _builder.append("* ");
            String _typeName_54 = this._cppExtensions.toTypeName(feature_18);
            String _firstLower_44 = StringExtensions.toFirstLower(_typeName_54);
            _builder.append(_firstLower_44, "            ");
            _builder.append(";");
            _builder.newLineIfNotEmpty();
            _builder.append("            ");
            String _typeName_55 = this._cppExtensions.toTypeName(feature_18);
            String _firstLower_45 = StringExtensions.toFirstLower(_typeName_55);
            _builder.append(_firstLower_45, "            ");
            _builder.append(" = m");
            String _name_247 = this._cppExtensions.toName(feature_18);
            String _firstUpper_120 = StringExtensions.toFirstUpper(_name_247);
            ...
            String _firstUpper_121 = StringExtensions.toFirstUpper(_name_248);
            ...
            String _firstUpper_122 = StringExtensions.toFirstUpper(_name_249);
            ...
            _builder.newLineIfNotEmpty();
            _builder.append("            ");
            String _typeName_56 = this._cppExtensions.toTypeName(feature_18);
            String _firstLower_46 = StringExtensions.toFirstLower(_typeName_56);
            ...
            String _firstUpper_123 = StringExtensions.toFirstUpper(_name_251);
            ...
            String _firstUpper_124 = StringExtensions.toFirstUpper(_name_252);
        ...
        String _firstLower_47 = StringExtensions.toFirstLower(_name_254);
        ...
        String _firstLower_48 = StringExtensions.toFirstLower(_name_256);
        ...
        String _firstUpper_125 = StringExtensions.toFirstUpper(_name_257);
        ...
        String _typeName_57 = this._cppExtensions.toTypeName(feature_18);
        ...
        String _firstUpper_126 = StringExtensions.toFirstUpper(_name_260);
        ...
        String _firstUpper_127 = StringExtensions.toFirstUpper(_name_262);
        _builder.append(_firstUpper_127, "");
        _builder.append("(QList<");
        String _typeName_58 = this._cppExtensions.toTypeName(feature_18);
        ...
        String _firstUpper_128 = StringExtensions.toFirstUpper(_name_265);
        ...
        String _firstLower_49 = StringExtensions.toFirstLower(_name_270);
        ...
        String _firstLower_50 = StringExtensions.toFirstLower(_name_272);
        ...
        String _typeName_59 = this._cppExtensions.toTypeName(feature_18);
        ...
        String _firstLower_51 = StringExtensions.toFirstLower(_name_274);
        ...
        String _firstLower_52 = StringExtensions.toFirstLower(_name_276);
        ...
        String _typeName_60 = this._cppExtensions.toTypeName(feature_18);
        ...
        String _typeName_61 = this._cppExtensions.toTypeName(feature_18);
        ...
        String _firstUpper_130 = StringExtensions.toFirstUpper(_name_281);
        ...
        _builder.append("::at");
        String _name_285 = this._cppExtensions.toName(feature_18);
        String _firstUpper_131 = StringExtensions.toFirstUpper(_name_285);
        ...
        String _firstUpper_132 = StringExtensions.toFirstUpper(_name_287);
        ...
        _builder.append("::appendTo");
        String _name_289 = this._cppExtensions.toName(feature_18);
        String _firstUpper_133 = StringExtensions.toFirstUpper(_name_289);
        _builder.append(_firstUpper_133, "");
        _builder.append("Property(QDeclarativeListProperty<");
        String _typeName_62 = this._cppExtensions.toTypeName(feature_18);
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("        ");
        String _typeName_63 = this._cppExtensions.toTypeName(feature_18);
        _builder.append(_typeName_63, "        ");
        _builder.append("* ");
        String _typeName_64 = this._cppExtensions.toTypeName(feature_18);
        String _firstLower_53 = StringExtensions.toFirstLower(_typeName_64);
        ...
        String _firstLower_54 = StringExtensions.toFirstLower(_name_292);
        ...
        String _firstLower_55 = StringExtensions.toFirstLower(_name_295);
        _builder.append(_firstLower_55, "    ");
        _builder.append("Object) {");
        _builder.newLineIfNotEmpty();
        _builder.append("        ");
        String _typeName_65 = this._cppExtensions.toTypeName(feature_18);
        String _firstLower_56 = StringExtensions.toFirstLower(_typeName_65);
        _builder.append(_firstLower_56, "        ");
        _builder.append("->setParent(");
        String _name_296 = this._cppExtensions.toName(dto);
        String _firstLower_57 = StringExtensions.toFirstLower(_name_296);
        _builder.append(_firstLower_57, "        ");
        _builder.append("Object);");
        _builder.newLineIfNotEmpty();
        _builder.append("        ");
        String _name_297 = this._cppExtensions.toName(dto);
        String _firstLower_58 = StringExtensions.toFirstLower(_name_297);
        _builder.append(_firstLower_58, "        ");
        _builder.append("Object->m");
        String _name_298 = this._cppExtensions.toName(feature_18);
        String _firstUpper_134 = StringExtensions.toFirstUpper(_name_298);
        _builder.append(_firstUpper_134, "        ");
        _builder.append(".append(");
        String _typeName_66 = this._cppExtensions.toTypeName(feature_18);
        String _firstLower_59 = StringExtensions.toFirstLower(_typeName_66);
        ...
        String _firstLower_60 = StringExtensions.toFirstLower(_name_299);
        _builder.append(_firstLower_60, "        ");
        _builder.append("Object->addedTo");
        String _name_300 = this._cppExtensions.toName(feature_18);
        String _firstUpper_135 = StringExtensions.toFirstUpper(_name_300);
        _builder.append(_firstUpper_135, "        ");
        _builder.append("(");
        String _typeName_67 = this._cppExtensions.toTypeName(feature_18);
        String _firstLower_61 = StringExtensions.toFirstLower(_typeName_67);
        ...
        String _typeName_68 = this._cppExtensions.toTypeName(feature_18);
        _builder.append(_typeName_68, "        ");
        _builder.append("* to ");
        String _name_301 = this._cppExtensions.toName(feature_18);
        ...
        _builder.append("::");
        String _name_304 = this._cppExtensions.toName(feature_18);
        _builder.append(_name_304, "");
        _builder.append("PropertyCount(QDeclarativeListProperty<");
        String _typeName_69 = this._cppExtensions.toTypeName(feature_18);
        _builder.append(_typeName_69, "");
        _builder.append("> *");
        String _name_305 = this._cppExtensions.toName(feature_18);
        ...
        _builder.append("    ");
        _builder.append("qDebug() << \"");
        String _name_306 = this._cppExtensions.toName(feature_18);
        ...
        String _firstLower_62 = StringExtensions.toFirstLower(_name_308);
        ...
        _builder.append(" *>(");
        String _name_310 = this._cppExtensions.toName(feature_18);
        ...
        String _firstLower_63 = StringExtensions.toFirstLower(_name_311);
        ...
        String _firstLower_64 = StringExtensions.toFirstLower(_name_312);
        _builder.append(_firstLower_64, "        ");
        _builder.append("->m");
        String _name_313 = this._cppExtensions.toName(feature_18);
        String _firstUpper_136 = StringExtensions.toFirstUpper(_name_313);
        ...
        String _name_314 = this._cppExtensions.toName(feature_18);
        ...
        _builder.append("}");
        _builder.newLine();
        String _typeName_70 = this._cppExtensions.toTypeName(feature_18);
        _builder.append(_typeName_70, "");
        _builder.append("* ");
        String _name_316 = this._cppExtensions.toName(dto);
        _builder.append(_name_316, "");
        _builder.append("::at");
        String _name_317 = this._cppExtensions.toName(feature_18);
        String _firstUpper_137 = StringExtensions.toFirstUpper(_name_317);
        _builder.append(_firstUpper_137, "");
        _builder.append("Property(QDeclarativeListProperty<");
        String _typeName_71 = this._cppExtensions.toTypeName(feature_18);
        _builder.append(_typeName_71, "");
        _builder.append("> *");
        String _name_318 = this._cppExtensions.toName(feature_18);
        ...
        String _name_319 = this._cppExtensions.toName(feature_18);
        String _firstUpper_138 = StringExtensions.toFirstUpper(_name_319);
        ...
        String _firstLower_65 = StringExtensions.toFirstLower(_name_321);
        _builder.append(_firstLower_65, "    ");
        _builder.append(" = qobject_cast<");
        String _name_322 = this._cppExtensions.toName(dto);
        _builder.append(_name_322, "    ");
        _builder.append(" *>(");
        String _name_323 = this._cppExtensions.toName(feature_18);
        ...
        String _firstLower_66 = StringExtensions.toFirstLower(_name_324);
        ...
        String _firstLower_67 = StringExtensions.toFirstLower(_name_325);
        _builder.append(_firstLower_67, "        ");
        _builder.append("->m");
        String _name_326 = this._cppExtensions.toName(feature_18);
        String _firstUpper_139 = StringExtensions.toFirstUpper(_name_326);
        ...
        String _firstLower_68 = StringExtensions.toFirstLower(_name_327);
        _builder.append(_firstLower_68, "            ");
        _builder.append("->m");
        String _name_328 = this._cppExtensions.toName(feature_18);
        String _firstUpper_140 = StringExtensions.toFirstUpper(_name_328);
        ...
        String _typeName_72 = this._cppExtensions.toTypeName(feature_18);
        ...
        String _firstLower_69 = StringExtensions.toFirstLower(_name_329);
        _builder.append(_firstLower_69, "                ");
        _builder.append("->m");
        String _name_330 = this._cppExtensions.toName(feature_18);
        String _firstUpper_141 = StringExtensions.toFirstUpper(_name_330);
        ...
        _builder.append("        ");
        _builder.append("qWarning() << \"cannot get ");
        String _typeName_73 = this._cppExtensions.toTypeName(feature_18);
        ...
        _builder.append("::clear");
        String _name_333 = this._cppExtensions.toName(feature_18);
        String _firstUpper_142 = StringExtensions.toFirstUpper(_name_333);
        _builder.append(_firstUpper_142, "");
        _builder.append("Property(QDeclarativeListProperty<");
        String _typeName_74 = this._cppExtensions.toTypeName(feature_18);
        _builder.append(_typeName_74, "");
        _builder.append("> *");
        String _name_334 = this._cppExtensions.toName(feature_18);
        ...
        String _firstLower_70 = StringExtensions.toFirstLower(_name_336);
        _builder.append(_firstLower_70, "    ");
        _builder.append(" = qobject_cast<");
        String _name_337 = this._cppExtensions.toName(dto);
        _builder.append(_name_337, "    ");
        _builder.append(" *>(");
        String _name_338 = this._cppExtensions.toName(feature_18);
        ...
        String _firstLower_71 = StringExtensions.toFirstLower(_name_339);
        _builder.append(_firstLower_71, "    ");
        _builder.append(") {");
        _builder.newLineIfNotEmpty();
        {
          boolean _hasOpposite_2 = this._cppExtensions.hasOpposite(feature_18);
          if (_hasOpposite_2) {
            _builder.append("        ");
            _builder.append("// ");
            String _name_340 = this._cppExtensions.toName(feature_18);
            ...
            String _firstLower_72 = StringExtensions.toFirstLower(_name_341);
            _builder.append(_firstLower_72, "        ");
            _builder.append("->m");
            String _name_342 = this._cppExtensions.toName(feature_18);
            String _firstUpper_143 = StringExtensions.toFirstUpper(_name_342);
            ...
            String _firstLower_73 = StringExtensions.toFirstLower(_name_343);
            _builder.append(_firstLower_73, "            ");
            _builder.append("->m");
            String _name_344 = this._cppExtensions.toName(feature_18);
            String _firstUpper_144 = StringExtensions.toFirstUpper(_name_344);
            ...
            _builder.append("        ");
            _builder.append("// ");
            String _name_345 = this._cppExtensions.toName(feature_18);
        ...
        String _firstLower_74 = StringExtensions.toFirstLower(_name_346);
        _builder.append(_firstLower_74, "        ");
        _builder.append("->m");
        String _name_347 = this._cppExtensions.toName(feature_18);
        String _firstUpper_145 = StringExtensions.toFirstUpper(_name_347);
        ...
        String _name_348 = this._cppExtensions.toName(feature_18);
