...
public class CppGenerator {
  ...
  public CharSequence toContent(final LDto dto) {
    ...
    _builder.append("::fillFromMap(QVariantMap ");
      ...
      for(final LFeature feature_3 : _filter_1) {
        {
          ...
          if (_isTypeOfDTO_2) {
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              boolean _equals = Objects.equal(_name_21, "uuid");
              if (_equals) {
                _builder.append("\t");
    ...
    }
    {
      ...
      for(final LFeature feature_4 : _filter_2) {
        ...
        String _firstLower_4 = StringExtensions.toFirstLower(_name_26);
        ...
        String _firstLower_6 = StringExtensions.toFirstLower(_name_29);
        ...
        String _firstLower_7 = StringExtensions.toFirstLower(_typeName_5);
        ...
        String _firstLower_8 = StringExtensions.toFirstLower(_typeName_7);
        ...
        String _firstUpper_9 = StringExtensions.toFirstUpper(_name_31);
        _builder.append(_firstUpper_9, "\t\t");
        _builder.append(".append(");
        String _typeName_9 = this._cppExtensions.toTypeName(feature_4);
        String _firstLower_11 = StringExtensions.toFirstLower(_typeName_9);
          ...
          if (_isTypeOfDTO_3) {
            {
              ...
              if (_not) {
                ...
                String _firstUpper_10 = StringExtensions.toFirstUpper(_name_36);
            ...
            String _firstUpper_16 = StringExtensions.toFirstUpper(_name_47);
          ...
          if (_isTypeOfDTO_4) {
            {
              ...
              if (_not_1) {
                ...
                String _firstUpper_18 = StringExtensions.toFirstUpper(_name_51);
      ...
      for(final LFeature feature_7 : _filter_3) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          if (_and_2) {
            ...
            String _firstUpper_23 = StringExtensions.toFirstUpper(_name_65);
            ...
            String _firstUpper_24 = StringExtensions.toFirstUpper(_name_67);
            ...
            String _firstUpper_25 = StringExtensions.toFirstUpper(_name_70);
