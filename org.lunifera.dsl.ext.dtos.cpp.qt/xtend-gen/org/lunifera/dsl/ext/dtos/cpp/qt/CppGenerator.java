  ...
  public CharSequence toContent(final LDto dto) {
    ...
    }
    {
      ...
      for(final LFeature feature_4 : _filter_2) {
        ...
        String _firstLower_3 = StringExtensions.toFirstLower(_name_22);
        ...
        String _firstLower_4 = StringExtensions.toFirstLower(_name_24);
        ...
        String _firstLower_5 = StringExtensions.toFirstLower(_name_26);
        ...
        String _firstLower_6 = StringExtensions.toFirstLower(_name_27);
        ...
        String _firstLower_10 = StringExtensions.toFirstLower(_name_28);
      ...
      for(final LFeature feature_5 : _allFeatures_5) {
        {
          ...
          boolean _endsWith_1 = _typeName_10.endsWith("DTO");
          if (_endsWith_1) {
            {
      ...
      for(final LFeature feature_6 : _allFeatures_6) {
        {
          ...
          boolean _endsWith_2 = _typeName_14.endsWith("DTO");
          if (_endsWith_2) {
            {
              ...
              if (_not_1) {
                _builder.append("\t");
                _builder.append("// m");
                String _name_47 = this._cppExtensions.toName(feature_6);
