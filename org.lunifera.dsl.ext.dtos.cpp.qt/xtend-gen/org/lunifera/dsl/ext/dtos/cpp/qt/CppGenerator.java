  ...
  public CharSequence toContent(final LDto dto) {
      ...
      for(final LFeature feature_7 : _filter_3) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          if (_and_2) {
            ...
            String _firstUpper_33 = StringExtensions.toFirstUpper(_name_79);
            ...
            _builder.append("::set");
            String _name_86 = this._cppExtensions.toName(feature_7);
            ...
            _builder.newLineIfNotEmpty();
            {
              boolean _isTypeOfDTO_6 = this._cppExtensions.isTypeOfDTO(feature_7);
              if (_isTypeOfDTO_6) {
                _builder.append("\t\t");
                _builder.append("if (m");
                String _name_90 = this._cppExtensions.toName(feature_7);
                ...
                String _firstUpper_40 = StringExtensions.toFirstUpper(_name_94);
            ...
            _builder.newLine();
            {
              boolean _isTypeOfDTO_7 = this._cppExtensions.isTypeOfDTO(feature_7);
              if (_isTypeOfDTO_7) {
                _builder.append("void ");
                ...
                String _firstLower_13 = StringExtensions.toFirstLower(_name_102);
                _builder.append(_firstLower_13, "\t\t");
                _builder.append("Deleted(m");
                String _name_103 = this._cppExtensions.toName(feature_7);
                String _firstUpper_44 = StringExtensions.toFirstUpper(_name_103);
                ...
                _builder.append("::has");
                String _name_107 = this._cppExtensions.toName(feature_7);
    ...
    }
    {
      ...
      for(final LFeature feature_8 : _filter_4) {
        ...
        String _firstLower_14 = StringExtensions.toFirstLower(_typeName_17);
        ...
        String _firstLower_16 = StringExtensions.toFirstLower(_typeName_20);
        ...
        String _firstUpper_55 = StringExtensions.toFirstUpper(_name_122);
        _builder.append(_firstUpper_55, "        ");
        _builder.append(".at(i) == ");
        String _typeName_21 = this._cppExtensions.toTypeName(feature_8);
        String _firstLower_17 = StringExtensions.toFirstLower(_typeName_21);
        ...
        String _firstUpper_56 = StringExtensions.toFirstUpper(_name_123);
        ...
        String _firstLower_18 = StringExtensions.toFirstLower(_name_124);
        ...
        String _firstUpper_57 = StringExtensions.toFirstUpper(_name_126);
        ...
        String _firstLower_19 = StringExtensions.toFirstLower(_typeName_23);
        ...
        String _firstLower_20 = StringExtensions.toFirstLower(_typeName_25);
        ...
        String _firstLower_21 = StringExtensions.toFirstLower(_typeName_27);
        _builder.append(_firstLower_21, "    ");
        _builder.append("->setParent(this);");
        _builder.newLineIfNotEmpty();
        _builder.append("    ");
        String _typeName_28 = this._cppExtensions.toTypeName(feature_8);
        String _firstLower_22 = StringExtensions.toFirstLower(_typeName_28);
        _builder.append(_firstLower_22, "    ");
        _builder.append("->fillFromMap(");
        String _typeName_29 = this._cppExtensions.toTypeName(feature_8);
        String _firstLower_23 = StringExtensions.toFirstLower(_typeName_29);
        _builder.append(_firstLower_23, "    ");
        _builder.append("Map);");
        _builder.newLineIfNotEmpty();
        _builder.append("    ");
        _builder.append("m");
        String _name_127 = this._cppExtensions.toName(feature_8);
        String _firstUpper_58 = StringExtensions.toFirstUpper(_name_127);
        ...
        _builder.append("::removeFrom");
        String _name_129 = this._cppExtensions.toName(feature_8);
        ...
        _builder.append("    ");
        _builder.append("for (int i = 0; i < m");
        String _name_130 = this._cppExtensions.toName(feature_8);
        String _firstUpper_60 = StringExtensions.toFirstUpper(_name_130);
        ...
        _builder.append("*>(m");
        String _name_131 = this._cppExtensions.toName(feature_8);
        ...
        _builder.append("            ");
        _builder.append("m");
        String _name_132 = this._cppExtensions.toName(feature_8);
        String _firstUpper_62 = StringExtensions.toFirstUpper(_name_132);
        ...
        String _name_133 = this._cppExtensions.toName(feature_8);
        String _firstLower_25 = StringExtensions.toFirstLower(_name_133);
        ...
        String _firstLower_26 = StringExtensions.toFirstLower(_name_135);
        ...
        String _firstUpper_64 = StringExtensions.toFirstUpper(_name_139);
        ...
        String _firstUpper_65 = StringExtensions.toFirstUpper(_name_141);
