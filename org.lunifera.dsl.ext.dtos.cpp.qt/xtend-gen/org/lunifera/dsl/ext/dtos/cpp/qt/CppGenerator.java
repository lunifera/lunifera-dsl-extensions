  ...
  public CharSequence toContent(final LDto dto) {
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_6 : _allFeatures_6) {
        ...
        String _firstUpper_9 = StringExtensions.toFirstUpper(_name_30);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_7 : _filter_3) {
        String _typeName = this._cppExtensions.toTypeName(feature_7);
    ...
    }
    {
      ...
      for(final LFeature feature_8 : _filter_4) {
        ...
        _builder.append("\t");
        _builder.append("return m");
        String _name_45 = this._cppExtensions.toName(feature_8);
        String _firstUpper_14 = StringExtensions.toFirstUpper(_name_45);
        ...
        _builder.append("::set");
        String _name_47 = this._cppExtensions.toName(feature_8);
