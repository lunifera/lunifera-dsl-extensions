  ...
  public CharSequence toContent(final LDto dto) {
      ...
      if (_existsServerName_1) {
        ...
        _builder.newLine();
        {
          ...
          for(final LFeature feature_7 : _allFeatures_7) {
            {
              boolean _isTypeOfDTO_4 = this._cppExtensions.isTypeOfDTO(feature_7);
              if (_isTypeOfDTO_4) {
                {
                  ...
                  if (_not_1) {
                    ...
                    _builder.newLineIfNotEmpty();
                    {
                      boolean _isToMany_1 = this._cppExtensions.isToMany(feature_7);
                      if (_isToMany_1) {
                        _builder.append("\t");
          ...
          if (_isTypeOfDTO_5) {
            {
              ...
              if (_not_2) {
                ...
                _builder.newLineIfNotEmpty();
                {
                  boolean _isToMany_2 = this._cppExtensions.isToMany(feature_8);
                  if (_isToMany_2) {
                    _builder.append("\t");
                    _builder.append("m");
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_10 : _filter_6) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          boolean _isTypeOfDTO_6 = this._cppExtensions.isTypeOfDTO(feature_10);
          if (!_isTypeOfDTO_6) {
            _and_2 = false;
          } else {
          ...
          if (_and_2) {
            ...
            String _firstUpper_45 = StringExtensions.toFirstUpper(_name_102);
            ...
            String _firstUpper_46 = StringExtensions.toFirstUpper(_name_104);
            ...
            _builder.newLine();
            {
              ...
              if (_isTypeOfDTO_8) {
                ...
                String _firstLower_13 = StringExtensions.toFirstLower(_name_120);
    ...
    }
    {
      ...
      for(final LFeature feature_11 : _filter_7) {
        ...
        String _firstLower_18 = StringExtensions.toFirstLower(_name_142);
        ...
        String _firstLower_25 = StringExtensions.toFirstLower(_name_151);
        ...
        String _firstLower_26 = StringExtensions.toFirstLower(_name_153);
        ...
        String _firstUpper_74 = StringExtensions.toFirstUpper(_name_154);
        ...
        String _firstUpper_75 = StringExtensions.toFirstUpper(_name_157);
        ...
        String _firstUpper_76 = StringExtensions.toFirstUpper(_name_159);
