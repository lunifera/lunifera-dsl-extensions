  ...
  public CharSequence toContent(final LDto dto) {
    ...
    }
    {
      ...
      for(final LFeature feature_5 : _filter_3) {
        ...
        String _firstLower_10 = StringExtensions.toFirstLower(_typeName_6);
        ...
        String _firstLower_11 = StringExtensions.toFirstLower(_typeName_8);
        ...
        String _firstLower_12 = StringExtensions.toFirstLower(_typeName_9);
        _builder.append(_firstLower_12, "\t\t");
        _builder.append("->fillFromMap(");
        String _name_59 = this._cppExtensions.toName(feature_5);
        String _firstLower_13 = StringExtensions.toFirstLower(_name_59);
        ...
        String _firstLower_14 = StringExtensions.toFirstLower(_typeName_10);
      ...
      for(final LFeature feature_6 : _filter_4) {
        {
          ...
          boolean _equals_1 = Objects.equal(_typeName_11, "QString");
          if (_equals_1) {
            _builder.append("\t");
            _builder.append("m");
            ...
            String _firstUpper_27 = StringExtensions.toFirstUpper(_name_62);
            ...
            String _firstUpper_28 = StringExtensions.toFirstUpper(_name_64);
            ...
            String _firstUpper_29 = StringExtensions.toFirstUpper(_name_67);
            ...
            String _firstUpper_31 = StringExtensions.toFirstUpper(_name_71);
            ...
            String _mapToSingleType = this._cppExtensions.mapToSingleType(feature_6);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_7 : _filter_5) {
        {
          boolean _isToMany = this._cppExtensions.isToMany(feature_7);
          if (_isToMany) {
            _builder.append("\t");
            _builder.append("if(m");
            ...
            boolean _isLazy_1 = this._cppExtensions.isLazy(feature_7);
            if (_isLazy_1) {
              _builder.append("\t");
              _builder.append("// ");
              ...
              _builder.newLineIfNotEmpty();
              _builder.append("\t");
              LFeature _referenceDomainKeyFeature = this._cppExtensions.referenceDomainKeyFeature(feature_7);
              String _typeName_13 = this._cppExtensions.toTypeName(_referenceDomainKeyFeature);
              String _name_77 = this._cppExtensions.toName(feature_7);
              String _validateReference = this._cppExtensions.toValidateReference(_typeName_13, _name_77);
              _builder.append(_validateReference, "\t");
              _builder.newLineIfNotEmpty();
            } else {
              boolean _isTypeOfDTO_3 = this._cppExtensions.isTypeOfDTO(feature_7);
              if (_isTypeOfDTO_3) {
                _builder.append("\t");
                _builder.append("if(!m");
                ...
                _builder.append("\t");
                String _validate = this._cppExtensions.toValidate(feature_7);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_8 : _filter_6) {
        ...
        _builder.append(" lazy pointing to ");
        String _typeOrQObject_2 = this._cppExtensions.toTypeOrQObject(feature_8);
        _builder.append(_typeOrQObject_2, "\t");
        _builder.append(" (domainKey: ");
        String _referenceDomainKey_2 = this._cppExtensions.referenceDomainKey(feature_8);
        ...
        String _firstUpper_34 = StringExtensions.toFirstUpper(_name_82);
        ...
        String _firstUpper_35 = StringExtensions.toFirstUpper(_name_84);
    ...
    }
    {
      ...
      for(final LFeature feature_9 : _filter_7) {
        {
          boolean _isTypeOfDTO_4 = this._cppExtensions.isTypeOfDTO(feature_9);
          if (_isTypeOfDTO_4) {
            {
              boolean _isContained_4 = this._cppExtensions.isContained(feature_9);
              boolean _not = (!_isContained_4);
              if (_not) {
                _builder.append("\t");
                _builder.append("// m");
                String _name_85 = this._cppExtensions.toName(feature_9);
                String _firstUpper_36 = StringExtensions.toFirstUpper(_name_85);
                ...
                _builder.newLineIfNotEmpty();
                {
                  boolean _isToMany_1 = this._cppExtensions.isToMany(feature_9);
                  if (_isToMany_1) {
                    _builder.append("\t");
                    _builder.append("m");
                    String _name_86 = this._cppExtensions.toName(dto);
                    String _firstUpper_37 = StringExtensions.toFirstUpper(_name_86);
                    ...
                    String _firstUpper_38 = StringExtensions.toFirstUpper(_name_89);
                    ...
                    String _firstUpper_40 = StringExtensions.toFirstUpper(_name_92);
              ...
              if (_isArrayList) {
                {
                  ...
                  if (_equals_2) {
                    ...
                    _builder.append("Map.insert(");
                    String _name_99 = this._cppExtensions.toName(feature_9);
                    _builder.append(_name_99, "\t");
                    _builder.append("Key, ");
                    String _name_100 = this._cppExtensions.toName(feature_9);
                ...
                String _firstUpper_45 = StringExtensions.toFirstUpper(_name_101);
                _builder.append(_firstUpper_45, "\t");
                _builder.append("Map.insert(");
                String _name_102 = this._cppExtensions.toName(feature_9);
                _builder.append(_name_102, "\t");
                _builder.append("Key, m");
                String _name_103 = this._cppExtensions.toName(feature_9);
    ...
    String _firstUpper_47 = StringExtensions.toFirstUpper(_name_104);
      ...
      if (_existsServerName_1) {
        ...
        _builder.newLine();
        {
          ...
          for(final LFeature feature_10 : _filter_8) {
            ...
            _builder.append(" (domainKey: ");
            String _referenceDomainKey_3 = this._cppExtensions.referenceDomainKey(feature_10);
            ...
            String _firstUpper_48 = StringExtensions.toFirstUpper(_name_109);
        ...
        }
        {
          ...
          for(final LFeature feature_11 : _filter_9) {
            {
              boolean _isTypeOfDTO_5 = this._cppExtensions.isTypeOfDTO(feature_11);
              if (_isTypeOfDTO_5) {
                {
                  boolean _isContained_5 = this._cppExtensions.isContained(feature_11);
                  boolean _not_1 = (!_isContained_5);
                  if (_not_1) {
                    _builder.append("\t");
                    _builder.append("// m");
                    String _name_110 = this._cppExtensions.toName(feature_11);
                    String _firstUpper_49 = StringExtensions.toFirstUpper(_name_110);
                    ...
                    _builder.newLineIfNotEmpty();
                    {
                      boolean _isToMany_2 = this._cppExtensions.isToMany(feature_11);
                      if (_isToMany_2) {
                        _builder.append("\t");
                        _builder.append("foreignMap.insert(");
                        ...
                        String _firstUpper_50 = StringExtensions.toFirstUpper(_name_113);
                        ...
                        _builder.append("->to");
                        String _mapOrList_1 = this._cppExtensions.toMapOrList(feature_11);
                    ...
                    String _firstUpper_52 = StringExtensions.toFirstUpper(_name_116);
                ...
                {
                  boolean _isArrayList_1 = this._cppExtensions.isArrayList(feature_11);
                  if (_isArrayList_1) {
                    {
                      String _typeName_19 = this._cppExtensions.toTypeName(feature_11);
                      boolean _equals_3 = Objects.equal(_typeName_19, "QString");
                      if (_equals_3) {
                        _builder.append("\t");
                        _builder.append("foreignMap.insert(");
                        ...
                        String _firstUpper_53 = StringExtensions.toFirstUpper(_name_119);
                    ...
                    String _firstUpper_54 = StringExtensions.toFirstUpper(_name_123);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_12 : _filter_10) {
        ...
        _builder.append(" lazy pointing to ");
        String _typeOrQObject_4 = this._cppExtensions.toTypeOrQObject(feature_12);
        _builder.append(_typeOrQObject_4, "\t");
        _builder.append(" (domainKey: ");
        String _referenceDomainKey_4 = this._cppExtensions.referenceDomainKey(feature_12);
    ...
    }
    {
      ...
      for(final LFeature feature_13 : _filter_11) {
        {
          boolean _isTypeOfDTO_6 = this._cppExtensions.isTypeOfDTO(feature_13);
          if (_isTypeOfDTO_6) {
            {
              boolean _isContained_6 = this._cppExtensions.isContained(feature_13);
              ...
              if (_not_2) {
                ...
                _builder.newLineIfNotEmpty();
                {
                  boolean _isToMany_3 = this._cppExtensions.isToMany(feature_13);
                  if (_isToMany_3) {
                    _builder.append("\t");
                    _builder.append("persistMap.insert(");
                    ...
                    String _firstUpper_57 = StringExtensions.toFirstUpper(_name_132);
                    ...
                    String _firstUpper_58 = StringExtensions.toFirstUpper(_name_134);
                    _builder.append(_firstUpper_58, "\t\t");
                    _builder.append("->to");
                    String _mapOrList_2 = this._cppExtensions.toMapOrList(feature_13);
                ...
                String _firstUpper_59 = StringExtensions.toFirstUpper(_name_135);
            ...
            {
              boolean _isArrayList_2 = this._cppExtensions.isArrayList(feature_13);
              if (_isArrayList_2) {
                {
                  String _typeName_22 = this._cppExtensions.toTypeName(feature_13);
                  boolean _equals_4 = Objects.equal(_typeName_22, "QString");
                  if (_equals_4) {
                    _builder.append("\t");
                    _builder.append("persistMap.insert(");
                    ...
                    String _firstUpper_60 = StringExtensions.toFirstUpper(_name_138);
                ...
                String _firstUpper_61 = StringExtensions.toFirstUpper(_name_142);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_15 : _filter_13) {
        CharSequence _foo = this.foo(feature_15);
        ...
        _builder.append(" lazy pointing to ");
        String _typeOrQObject_5 = this._cppExtensions.toTypeOrQObject(feature_15);
        _builder.append(_typeOrQObject_5, "");
        _builder.append(" (domainKey: ");
        String _referenceDomainKey_5 = this._cppExtensions.referenceDomainKey(feature_15);
        ...
        String _firstUpper_63 = StringExtensions.toFirstUpper(_name_147);
        _builder.append(_firstUpper_63, "\t");
        _builder.append(";");
        _builder.newLineIfNotEmpty();
        _builder.append("}");
        _builder.newLine();
        String _typeOrQObject_6 = this._cppExtensions.toTypeOrQObject(feature_15);
        ...
        String _firstUpper_64 = StringExtensions.toFirstUpper(_name_150);
        ...
        String _firstUpper_65 = StringExtensions.toFirstUpper(_name_152);
        ...
        String _firstUpper_66 = StringExtensions.toFirstUpper(_name_155);
        ...
        String _firstUpper_67 = StringExtensions.toFirstUpper(_name_157);
        ...
        String _firstUpper_68 = StringExtensions.toFirstUpper(_name_159);
        ...
        String _firstUpper_69 = StringExtensions.toFirstUpper(_name_161);
        ...
        String _firstUpper_70 = StringExtensions.toFirstUpper(_name_162);
        ...
        String _firstUpper_72 = StringExtensions.toFirstUpper(_name_168);
        ...
        String _firstUpper_73 = StringExtensions.toFirstUpper(_name_170);
        ...
        String _firstUpper_74 = StringExtensions.toFirstUpper(_name_171);
        _builder.append(_firstUpper_74, "    ");
        _builder.append(" != ");
        String _referenceDomainKeyType_7 = this._cppExtensions.referenceDomainKeyType(feature_15);
        ...
        String _firstUpper_75 = StringExtensions.toFirstUpper(_name_173);
        ...
        String _firstUpper_76 = StringExtensions.toFirstUpper(_name_174);
        ...
        String _firstUpper_77 = StringExtensions.toFirstUpper(_name_176);
        _builder.append(_firstUpper_77, "");
        _builder.append("AsDTO(");
        String _typeOrQObject_7 = this._cppExtensions.toTypeOrQObject(feature_15);
        _builder.append(_typeOrQObject_7, "");
        _builder.append(" ");
        String _typeName_23 = this._cppExtensions.toTypeName(feature_15);
        String _firstLower_16 = StringExtensions.toFirstLower(_typeName_23);
        ...
        String _firstLower_17 = StringExtensions.toFirstLower(_typeName_24);
        ...
        String _firstLower_18 = StringExtensions.toFirstLower(_typeName_25);
        _builder.append(_firstLower_18, "        ");
        _builder.append("->");
        String _referenceDomainKey_6 = this._cppExtensions.referenceDomainKey(feature_15);
        _builder.append(_referenceDomainKey_6, "        ");
        _builder.append("() == m");
        String _name_177 = this._cppExtensions.toName(feature_15);
        String _firstUpper_78 = StringExtensions.toFirstUpper(_name_177);
        _builder.append(_firstUpper_78, "        ");
        _builder.append(") {");
        _builder.newLineIfNotEmpty();
        _builder.append("            ");
        _builder.append("m");
        String _name_178 = this._cppExtensions.toName(feature_15);
        String _firstUpper_79 = StringExtensions.toFirstUpper(_name_178);
        _builder.append(_firstUpper_79, "            ");
        _builder.append("AsDTO = ");
        String _typeName_26 = this._cppExtensions.toTypeName(feature_15);
        String _firstLower_19 = StringExtensions.toFirstLower(_typeName_26);
    ...
    }
    {
      ...
      for(final LFeature feature_16 : _filter_14) {
        CharSequence _foo_1 = this.foo(feature_16);
        _builder.append(_foo_1, "");
        _builder.newLineIfNotEmpty();
        {
          boolean _and_2 = false;
          boolean _isTypeOfDTO_7 = this._cppExtensions.isTypeOfDTO(feature_16);
          if (!_isTypeOfDTO_7) {
            _and_2 = false;
          } else {
            boolean _isContained_7 = this._cppExtensions.isContained(feature_16);
            _and_2 = _isContained_7;
          }
          if (_and_2) {
            _builder.append("// No SETTER for ");
            String _name_179 = this._cppExtensions.toName(feature_16);
            String _firstUpper_80 = StringExtensions.toFirstUpper(_name_179);
            _builder.append(_firstUpper_80, "");
            _builder.append(" - it\'s the parent");
            _builder.newLineIfNotEmpty();
            String _typeOrQObject_8 = this._cppExtensions.toTypeOrQObject(feature_16);
            ...
            String _typeOrQObject_9 = this._cppExtensions.toTypeOrQObject(feature_16);
            ...
            boolean _isEnum = this._cppExtensions.isEnum(feature_16);
            if (_isEnum) {
              _builder.append("int ");
              ...
              String _firstUpper_81 = StringExtensions.toFirstUpper(_name_184);
              ...
              String _firstUpper_82 = StringExtensions.toFirstUpper(_name_186);
              ...
              String _firstUpper_83 = StringExtensions.toFirstUpper(_name_189);
              ...
              String _firstUpper_84 = StringExtensions.toFirstUpper(_name_190);
              ...
              String _typeOrQObject_10 = this._cppExtensions.toTypeOrQObject(feature_16);
              ...
              String _firstUpper_85 = StringExtensions.toFirstUpper(_name_196);
              ...
              String _firstUpper_86 = StringExtensions.toFirstUpper(_name_198);
              _builder.append(_firstUpper_86, "");
              _builder.append("(");
              String _typeOrQObject_11 = this._cppExtensions.toTypeOrQObject(feature_16);
              ...
              _builder.append("\t");
              _builder.append("if (");
              String _name_200 = this._cppExtensions.toName(feature_16);
              _builder.append(_name_200, "\t");
              _builder.append(" != m");
              String _name_201 = this._cppExtensions.toName(feature_16);
              String _firstUpper_87 = StringExtensions.toFirstUpper(_name_201);
              _builder.append(_firstUpper_87, "\t");
              _builder.append(") {");
              _builder.newLineIfNotEmpty();
              {
                boolean _isTypeOfDTO_8 = this._cppExtensions.isTypeOfDTO(feature_16);
                if (_isTypeOfDTO_8) {
                  _builder.append("\t\t");
                  _builder.append("if (m");
                  String _name_202 = this._cppExtensions.toName(feature_16);
                  String _firstUpper_88 = StringExtensions.toFirstUpper(_name_202);
                  ...
                  String _firstUpper_89 = StringExtensions.toFirstUpper(_name_203);
                  ...
                  String _firstUpper_90 = StringExtensions.toFirstUpper(_name_204);
                  ...
                  _builder.append("\t\t");
                  _builder.append("m");
                  String _name_206 = this._cppExtensions.toName(feature_16);
                  String _firstUpper_91 = StringExtensions.toFirstUpper(_name_206);
                  ...
                  String _firstUpper_92 = StringExtensions.toFirstUpper(_name_207);
              ...
              _builder.append("\t\t");
              _builder.append("emit ");
              String _name_209 = this._cppExtensions.toName(feature_16);
              ...
              _builder.newLine();
              {
                boolean _isTypeOfDTO_9 = this._cppExtensions.isTypeOfDTO(feature_16);
                if (_isTypeOfDTO_9) {
                  _builder.append("void ");
                  String _name_211 = this._cppExtensions.toName(dto);
                  _builder.append(_name_211, "");
                  _builder.append("::delete");
                  String _name_212 = this._cppExtensions.toName(feature_16);
                  String _firstUpper_93 = StringExtensions.toFirstUpper(_name_212);
                  ...
                  String _firstUpper_94 = StringExtensions.toFirstUpper(_name_213);
                  ...
                  String _firstLower_20 = StringExtensions.toFirstLower(_name_214);
                  _builder.append(_firstLower_20, "\t\t");
                  _builder.append("Deleted(m");
                  String _name_215 = this._cppExtensions.toName(feature_16);
                  String _firstUpper_95 = StringExtensions.toFirstUpper(_name_215);
                  ...
                  String _firstUpper_96 = StringExtensions.toFirstUpper(_name_216);
                  ...
                  String _firstUpper_97 = StringExtensions.toFirstUpper(_name_217);
                  ...
                  String _firstUpper_98 = StringExtensions.toFirstUpper(_name_219);
                  ...
                  String _firstUpper_99 = StringExtensions.toFirstUpper(_name_220);
    ...
    }
    {
      ...
      for(final LFeature feature_17 : _filter_15) {
        CharSequence _foo_2 = this.foo(feature_17);
        ...
        String _firstUpper_100 = StringExtensions.toFirstUpper(_name_222);
        ...
        String _firstUpper_101 = StringExtensions.toFirstUpper(_name_223);
        ...
        String _firstLower_22 = StringExtensions.toFirstLower(_typeName_29);
        ...
        String _firstUpper_102 = StringExtensions.toFirstUpper(_name_224);
        ...
        String _firstUpper_103 = StringExtensions.toFirstUpper(_name_226);
        ...
        String _firstUpper_104 = StringExtensions.toFirstUpper(_name_227);
        ...
        String _firstUpper_105 = StringExtensions.toFirstUpper(_name_228);
        ...
        String _firstLower_25 = StringExtensions.toFirstLower(_typeName_33);
        ...
        String _firstUpper_106 = StringExtensions.toFirstUpper(_name_229);
        ...
        String _firstUpper_107 = StringExtensions.toFirstUpper(_name_230);
        _builder.append(_firstUpper_107, "            ");
        _builder.append("StringList(");
        String _typeName_34 = this._cppExtensions.toTypeName(feature_17);
        String _firstLower_26 = StringExtensions.toFirstLower(_typeName_34);
        ...
        String _firstLower_27 = StringExtensions.toFirstLower(_name_231);
        ...
        String _firstLower_28 = StringExtensions.toFirstLower(_name_233);
        ...
        String _firstUpper_108 = StringExtensions.toFirstUpper(_name_234);
        ...
        String _firstUpper_109 = StringExtensions.toFirstUpper(_name_237);
        ...
        _builder.append("::set");
        String _name_239 = this._cppExtensions.toName(feature_17);
        String _firstUpper_110 = StringExtensions.toFirstUpper(_name_239);
        ...
        String _firstUpper_111 = StringExtensions.toFirstUpper(_name_242);
        ...
        String _firstUpper_112 = StringExtensions.toFirstUpper(_name_243);
    ...
    }
    {
      ...
      for(final LFeature feature_18 : _filter_16) {
        CharSequence _foo_3 = this.foo(feature_18);
        ...
        String _firstUpper_113 = StringExtensions.toFirstUpper(_name_248);
        ...
        String _firstUpper_114 = StringExtensions.toFirstUpper(_typeName_37);
        ...
        String _firstUpper_115 = StringExtensions.toFirstUpper(_name_249);
        _builder.append(_firstUpper_115, "    ");
        _builder.append(".append(the");
        String _typeName_38 = this._cppExtensions.toTypeName(feature_18);
        String _firstUpper_116 = StringExtensions.toFirstUpper(_typeName_38);
        ...
        String _firstUpper_118 = StringExtensions.toFirstUpper(_typeName_39);
        ...
        String _firstUpper_119 = StringExtensions.toFirstUpper(_name_252);
        _builder.append(_firstUpper_119, "");
        _builder.append("List(const ");
        String _typeName_40 = this._cppExtensions.toTypeName(feature_18);
        _builder.append(_typeName_40, "");
        _builder.append("& the");
        String _typeName_41 = this._cppExtensions.toTypeName(feature_18);
        String _firstUpper_120 = StringExtensions.toFirstUpper(_typeName_41);
        ...
        String _firstUpper_121 = StringExtensions.toFirstUpper(_name_253);
        ...
        String _firstUpper_122 = StringExtensions.toFirstUpper(_name_254);
        _builder.append(_firstUpper_122, "        ");
        _builder.append(".at(i) == the");
        String _typeName_42 = this._cppExtensions.toTypeName(feature_18);
        String _firstUpper_123 = StringExtensions.toFirstUpper(_typeName_42);
        ...
        String _firstUpper_124 = StringExtensions.toFirstUpper(_name_255);
        ...
        String _firstUpper_125 = StringExtensions.toFirstUpper(_name_256);
        _builder.append(_firstUpper_125, "            ");
        _builder.append("List(the");
        String _typeName_43 = this._cppExtensions.toTypeName(feature_18);
        String _firstUpper_126 = StringExtensions.toFirstUpper(_typeName_43);
        ...
        _builder.append("    ");
        _builder.append("qDebug() << \"");
        String _typeName_44 = this._cppExtensions.toTypeName(feature_18);
        _builder.append(_typeName_44, "    ");
        _builder.append("& not found in ");
        String _name_257 = this._cppExtensions.toName(feature_18);
        String _firstLower_29 = StringExtensions.toFirstLower(_name_257);
        ...
        String _firstLower_30 = StringExtensions.toFirstLower(_name_259);
        ...
        String _firstUpper_127 = StringExtensions.toFirstUpper(_name_260);
        ...
        String _typeName_45 = this._cppExtensions.toTypeName(feature_18);
        ...
        String _firstUpper_128 = StringExtensions.toFirstUpper(_name_263);
        ...
        String _firstUpper_129 = StringExtensions.toFirstUpper(_name_265);
        _builder.append(_firstUpper_129, "");
        _builder.append("(QList<");
        String _typeName_46 = this._cppExtensions.toTypeName(feature_18);
        ...
        String _firstUpper_130 = StringExtensions.toFirstUpper(_name_268);
        ...
        String _firstUpper_131 = StringExtensions.toFirstUpper(_name_269);
        ...
        String _firstUpper_132 = StringExtensions.toFirstUpper(_name_276);
        _builder.append(_firstUpper_132, "    ");
        _builder.append(".size(); ++i) {");
        _builder.newLineIfNotEmpty();
        _builder.append("        ");
        _builder.append("variantList.append(m");
        String _name_277 = this._cppExtensions.toName(feature_18);
        String _firstUpper_133 = StringExtensions.toFirstUpper(_name_277);
        ...
        String _firstUpper_134 = StringExtensions.toFirstUpper(_name_279);
        ...
        _builder.append("\t");
        _builder.append("m");
        String _name_281 = this._cppExtensions.toName(feature_18);
        String _firstUpper_135 = StringExtensions.toFirstUpper(_name_281);
        _builder.append(_firstUpper_135, "\t");
        _builder.append(".clear();");
        _builder.newLineIfNotEmpty();
        _builder.append("    ");
        _builder.append("for (int i = 0; i < ");
        String _name_282 = this._cppExtensions.toName(feature_18);
        ...
        String _firstUpper_136 = StringExtensions.toFirstUpper(_name_283);
    ...
    }
    {
      ...
      for(final LFeature feature_19 : _filter_17) {
        CharSequence _foo_4 = this.foo(feature_19);
        ...
        String _firstUpper_138 = StringExtensions.toFirstUpper(_name_290);
        ...
        String _firstLower_31 = StringExtensions.toFirstLower(_typeName_48);
        ...
        String _firstUpper_140 = StringExtensions.toFirstUpper(_name_294);
        _builder.append(_firstUpper_140, "    ");
        _builder.append(".append(");
        String _typeName_49 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_32 = StringExtensions.toFirstLower(_typeName_49);
        ...
        String _firstUpper_141 = StringExtensions.toFirstUpper(_name_295);
        _builder.append(_firstUpper_141, "    ");
        _builder.append("(");
        String _typeName_50 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_33 = StringExtensions.toFirstLower(_typeName_50);
        ...
        String _firstUpper_142 = StringExtensions.toFirstUpper(_name_297);
        ...
        String _firstLower_34 = StringExtensions.toFirstLower(_typeName_52);
        ...
        String _firstUpper_144 = StringExtensions.toFirstUpper(_name_299);
        _builder.append(_firstUpper_144, "        ");
        _builder.append(".at(i) == ");
        String _typeName_53 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_35 = StringExtensions.toFirstLower(_typeName_53);
        ...
        String _firstUpper_146 = StringExtensions.toFirstUpper(_name_301);
        _builder.append(_firstUpper_146, "            ");
        _builder.append("(");
        String _typeName_54 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_36 = StringExtensions.toFirstLower(_typeName_54);
        _builder.append(_firstLower_36, "            ");
        _builder.append("->uuid());");
        _builder.newLineIfNotEmpty();
        {
          boolean _hasOpposite = this._cppExtensions.hasOpposite(feature_19);
          if (_hasOpposite) {
            _builder.append("            ");
            _builder.append("// ");
            ...
            _builder.newLineIfNotEmpty();
            _builder.append("            ");
            String _typeName_55 = this._cppExtensions.toTypeName(feature_19);
            String _firstLower_37 = StringExtensions.toFirstLower(_typeName_55);
        ...
        _builder.append("    ");
        _builder.append("qDebug() << \"");
        String _typeName_56 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_56, "    ");
        _builder.append("* not found in ");
        String _name_304 = this._cppExtensions.toName(feature_19);
        String _firstLower_38 = StringExtensions.toFirstLower(_name_304);
        ...
        _builder.append("::addTo");
        String _name_306 = this._cppExtensions.toName(feature_19);
        ...
        String _typeName_57 = this._cppExtensions.toTypeName(feature_19);
        ...
        _builder.newLine();
        _builder.append("    ");
        String _typeName_58 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_58, "    ");
        _builder.append("* ");
        String _typeName_59 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_40 = StringExtensions.toFirstLower(_typeName_59);
        _builder.append(_firstLower_40, "    ");
        _builder.append(" = new ");
        String _typeName_60 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_60, "    ");
        _builder.append("();");
        _builder.newLineIfNotEmpty();
        _builder.append("    ");
        String _typeName_61 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_41 = StringExtensions.toFirstLower(_typeName_61);
        _builder.append(_firstLower_41, "    ");
        _builder.append("->setParent(this);");
        _builder.newLineIfNotEmpty();
        _builder.append("    ");
        String _typeName_62 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_42 = StringExtensions.toFirstLower(_typeName_62);
        _builder.append(_firstLower_42, "    ");
        _builder.append("->fillFromMap(");
        String _typeName_63 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_43 = StringExtensions.toFirstLower(_typeName_63);
        ...
        _builder.append(".append(");
        String _typeName_64 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_44 = StringExtensions.toFirstLower(_typeName_64);
        ...
        _builder.append("(");
        String _typeName_65 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_45 = StringExtensions.toFirstLower(_typeName_65);
        ...
        _builder.newLineIfNotEmpty();
        {
          boolean _hasOpposite_1 = this._cppExtensions.hasOpposite(feature_19);
          if (_hasOpposite_1) {
            _builder.append("            ");
            String _typeName_66 = this._cppExtensions.toTypeName(feature_19);
            _builder.append(_typeName_66, "            ");
            _builder.append("* ");
            String _typeName_67 = this._cppExtensions.toTypeName(feature_19);
            String _firstLower_46 = StringExtensions.toFirstLower(_typeName_67);
            _builder.append(_firstLower_46, "            ");
            _builder.append(";");
            _builder.newLineIfNotEmpty();
            _builder.append("            ");
            String _typeName_68 = this._cppExtensions.toTypeName(feature_19);
            String _firstLower_47 = StringExtensions.toFirstLower(_typeName_68);
            _builder.append(_firstLower_47, "            ");
            _builder.append(" = m");
            String _name_313 = this._cppExtensions.toName(feature_19);
            ...
            _builder.append("            ");
            _builder.append("m");
            String _name_314 = this._cppExtensions.toName(feature_19);
            ...
            _builder.append("            ");
            _builder.append("emit removedFrom");
            String _name_315 = this._cppExtensions.toName(feature_19);
            String _firstUpper_155 = StringExtensions.toFirstUpper(_name_315);
            _builder.append(_firstUpper_155, "            ");
            _builder.append("(uuid);");
            _builder.newLineIfNotEmpty();
            _builder.append("            ");
            _builder.append("// ");
            String _name_316 = this._cppExtensions.toName(feature_19);
            _builder.append(_name_316, "            ");
            _builder.append(" are contained - so we must delete them");
            _builder.newLineIfNotEmpty();
            _builder.append("            ");
            String _typeName_69 = this._cppExtensions.toTypeName(feature_19);
            String _firstLower_48 = StringExtensions.toFirstLower(_typeName_69);
            ...
            _builder.append("            ");
            _builder.append("m");
            String _name_317 = this._cppExtensions.toName(feature_19);
            String _firstUpper_156 = StringExtensions.toFirstUpper(_name_317);
            _builder.append(_firstUpper_156, "            ");
            _builder.append(".removeAt(i);");
            _builder.newLineIfNotEmpty();
            _builder.append("            ");
            _builder.append("emit removedFrom");
            String _name_318 = this._cppExtensions.toName(feature_19);
            String _firstUpper_157 = StringExtensions.toFirstUpper(_name_318);
            _builder.append(_firstUpper_157, "            ");
            _builder.append("(uuid);");
            _builder.newLineIfNotEmpty();
            _builder.append("            ");
            _builder.append("// ");
            String _name_319 = this._cppExtensions.toName(feature_19);
        ...
        String _name_320 = this._cppExtensions.toName(feature_19);
        String _firstLower_49 = StringExtensions.toFirstLower(_name_320);
        ...
        _builder.append("::");
        String _name_322 = this._cppExtensions.toName(feature_19);
        String _firstLower_50 = StringExtensions.toFirstLower(_name_322);
        _builder.append(_firstLower_50, "");
        _builder.append("Count(){");
        _builder.newLineIfNotEmpty();
        _builder.append("    ");
        _builder.append("return m");
        String _name_323 = this._cppExtensions.toName(feature_19);
        ...
        _builder.newLine();
        _builder.append("QList<");
        String _typeName_70 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_70, "");
        _builder.append("*> ");
        String _name_324 = this._cppExtensions.toName(dto);
        _builder.append(_name_324, "");
        _builder.append("::");
        String _name_325 = this._cppExtensions.toName(feature_19);
        ...
        _builder.append("\t");
        _builder.append("return m");
        String _name_326 = this._cppExtensions.toName(feature_19);
        String _firstUpper_159 = StringExtensions.toFirstUpper(_name_326);
        ...
        _builder.append("::set");
        String _name_328 = this._cppExtensions.toName(feature_19);
        String _firstUpper_160 = StringExtensions.toFirstUpper(_name_328);
        _builder.append(_firstUpper_160, "");
        _builder.append("(QList<");
        String _typeName_71 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_71, "");
        _builder.append("*> ");
        String _name_329 = this._cppExtensions.toName(feature_19);
        ...
        _builder.append("\t");
        _builder.append("if (");
        String _name_330 = this._cppExtensions.toName(feature_19);
        _builder.append(_name_330, "\t");
        _builder.append(" != m");
        String _name_331 = this._cppExtensions.toName(feature_19);
        String _firstUpper_161 = StringExtensions.toFirstUpper(_name_331);
        _builder.append(_firstUpper_161, "\t");
        _builder.append(") {");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.append("m");
        String _name_332 = this._cppExtensions.toName(feature_19);
        String _firstUpper_162 = StringExtensions.toFirstUpper(_name_332);
        _builder.append(_firstUpper_162, "\t\t");
        _builder.append(" = ");
        String _name_333 = this._cppExtensions.toName(feature_19);
        _builder.append(_name_333, "\t\t");
        _builder.append(";");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.append("emit ");
        String _name_334 = this._cppExtensions.toName(feature_19);
        _builder.append(_name_334, "\t\t");
        _builder.append("Changed(");
        String _name_335 = this._cppExtensions.toName(feature_19);
        ...
        String _firstLower_51 = StringExtensions.toFirstLower(_name_336);
        _builder.append(_firstLower_51, " ");
        _builder.append(".");
        String _name_337 = this._cppExtensions.toName(feature_19);
        ...
        String _firstLower_52 = StringExtensions.toFirstLower(_name_338);
        _builder.append(_firstLower_52, " ");
        _builder.append(".");
        String _name_339 = this._cppExtensions.toName(feature_19);
        _builder.append(_name_339, " ");
        _builder.append("PropertyList[2] to get ");
        String _typeName_72 = this._cppExtensions.toTypeName(feature_19);
        ...
        String _firstLower_53 = StringExtensions.toFirstLower(_name_340);
        _builder.append(_firstLower_53, " ");
        _builder.append(".");
        String _name_341 = this._cppExtensions.toName(feature_19);
        ...
        String _firstLower_54 = StringExtensions.toFirstLower(_name_342);
        _builder.append(_firstLower_54, " ");
        _builder.append(".");
        String _name_343 = this._cppExtensions.toName(feature_19);
        ...
        String _typeName_73 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_73, "");
        _builder.append("> ");
        String _name_344 = this._cppExtensions.toName(dto);
        _builder.append(_name_344, "");
        _builder.append("::");
        String _name_345 = this._cppExtensions.toName(feature_19);
        ...
        String _typeName_74 = this._cppExtensions.toTypeName(feature_19);
        ...
        String _name_347 = this._cppExtensions.toName(feature_19);
        String _firstUpper_163 = StringExtensions.toFirstUpper(_name_347);
        ...
        _builder.append("::");
        String _name_349 = this._cppExtensions.toName(feature_19);
        ...
        _builder.append("::at");
        String _name_351 = this._cppExtensions.toName(feature_19);
        String _firstUpper_164 = StringExtensions.toFirstUpper(_name_351);
        ...
        _builder.append("::clear");
        String _name_353 = this._cppExtensions.toName(feature_19);
        String _firstUpper_165 = StringExtensions.toFirstUpper(_name_353);
        ...
        _builder.append("::appendTo");
        String _name_355 = this._cppExtensions.toName(feature_19);
        String _firstUpper_166 = StringExtensions.toFirstUpper(_name_355);
        _builder.append(_firstUpper_166, "");
        _builder.append("Property(QDeclarativeListProperty<");
        String _typeName_75 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_75, "");
        _builder.append("> *");
        String _name_356 = this._cppExtensions.toName(feature_19);
        _builder.append(_name_356, "");
        _builder.append("List,");
        _builder.newLineIfNotEmpty();
        _builder.append("        ");
        String _typeName_76 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_76, "        ");
        _builder.append("* ");
        String _typeName_77 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_55 = StringExtensions.toFirstLower(_typeName_77);
        ...
        String _firstLower_56 = StringExtensions.toFirstLower(_name_358);
        ...
        _builder.append(" *>(");
        String _name_360 = this._cppExtensions.toName(feature_19);
        ...
        String _firstLower_57 = StringExtensions.toFirstLower(_name_361);
        _builder.append(_firstLower_57, "    ");
        _builder.append("Object) {");
        _builder.newLineIfNotEmpty();
        _builder.append("        ");
        String _typeName_78 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_58 = StringExtensions.toFirstLower(_typeName_78);
        _builder.append(_firstLower_58, "        ");
        _builder.append("->setParent(");
        String _name_362 = this._cppExtensions.toName(dto);
        String _firstLower_59 = StringExtensions.toFirstLower(_name_362);
        _builder.append(_firstLower_59, "        ");
        _builder.append("Object);");
        _builder.newLineIfNotEmpty();
        _builder.append("        ");
        String _name_363 = this._cppExtensions.toName(dto);
        String _firstLower_60 = StringExtensions.toFirstLower(_name_363);
        _builder.append(_firstLower_60, "        ");
        _builder.append("Object->m");
        String _name_364 = this._cppExtensions.toName(feature_19);
        String _firstUpper_167 = StringExtensions.toFirstUpper(_name_364);
        _builder.append(_firstUpper_167, "        ");
        _builder.append(".append(");
        String _typeName_79 = this._cppExtensions.toTypeName(feature_19);
        String _firstLower_61 = StringExtensions.toFirstLower(_typeName_79);
        ...
        String _firstLower_62 = StringExtensions.toFirstLower(_name_365);
        _builder.append(_firstLower_62, "        ");
        _builder.append("Object->addedTo");
        String _name_366 = this._cppExtensions.toName(feature_19);
        String _firstUpper_168 = StringExtensions.toFirstUpper(_name_366);
        _builder.append(_firstUpper_168, "        ");
        _builder.append("(");
        String _typeName_80 = this._cppExtensions.toTypeName(feature_19);
        ...
        String _typeName_81 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_81, "        ");
        _builder.append("* to ");
        String _name_367 = this._cppExtensions.toName(feature_19);
        ...
        _builder.append("::");
        String _name_370 = this._cppExtensions.toName(feature_19);
        _builder.append(_name_370, "");
        _builder.append("PropertyCount(QDeclarativeListProperty<");
        String _typeName_82 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_82, "");
        _builder.append("> *");
        String _name_371 = this._cppExtensions.toName(feature_19);
        ...
        _builder.append("    ");
        _builder.append("qDebug() << \"");
        String _name_372 = this._cppExtensions.toName(feature_19);
        ...
        String _firstLower_64 = StringExtensions.toFirstLower(_name_374);
        ...
        _builder.append(" *>(");
        String _name_376 = this._cppExtensions.toName(feature_19);
        ...
        String _firstLower_65 = StringExtensions.toFirstLower(_name_377);
        ...
        String _firstLower_66 = StringExtensions.toFirstLower(_name_378);
        _builder.append(_firstLower_66, "        ");
        _builder.append("->m");
        String _name_379 = this._cppExtensions.toName(feature_19);
        String _firstUpper_169 = StringExtensions.toFirstUpper(_name_379);
        ...
        String _name_380 = this._cppExtensions.toName(feature_19);
        ...
        _builder.append("}");
        _builder.newLine();
        String _typeName_83 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_83, "");
        _builder.append("* ");
        String _name_382 = this._cppExtensions.toName(dto);
        _builder.append(_name_382, "");
        _builder.append("::at");
        String _name_383 = this._cppExtensions.toName(feature_19);
        String _firstUpper_170 = StringExtensions.toFirstUpper(_name_383);
        _builder.append(_firstUpper_170, "");
        _builder.append("Property(QDeclarativeListProperty<");
        String _typeName_84 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_84, "");
        _builder.append("> *");
        String _name_384 = this._cppExtensions.toName(feature_19);
        ...
        String _name_385 = this._cppExtensions.toName(feature_19);
        String _firstUpper_171 = StringExtensions.toFirstUpper(_name_385);
        ...
        String _firstLower_67 = StringExtensions.toFirstLower(_name_387);
        _builder.append(_firstLower_67, "    ");
        _builder.append(" = qobject_cast<");
        String _name_388 = this._cppExtensions.toName(dto);
        _builder.append(_name_388, "    ");
        _builder.append(" *>(");
        String _name_389 = this._cppExtensions.toName(feature_19);
        ...
        String _firstLower_68 = StringExtensions.toFirstLower(_name_390);
        ...
        String _firstLower_69 = StringExtensions.toFirstLower(_name_391);
        _builder.append(_firstLower_69, "        ");
        _builder.append("->m");
        String _name_392 = this._cppExtensions.toName(feature_19);
        String _firstUpper_172 = StringExtensions.toFirstUpper(_name_392);
        ...
        String _firstLower_70 = StringExtensions.toFirstLower(_name_393);
        _builder.append(_firstLower_70, "            ");
        _builder.append("->m");
        String _name_394 = this._cppExtensions.toName(feature_19);
        String _firstUpper_173 = StringExtensions.toFirstUpper(_name_394);
        ...
        String _typeName_85 = this._cppExtensions.toTypeName(feature_19);
        ...
        String _firstLower_71 = StringExtensions.toFirstLower(_name_395);
        _builder.append(_firstLower_71, "                ");
        _builder.append("->m");
        String _name_396 = this._cppExtensions.toName(feature_19);
        String _firstUpper_174 = StringExtensions.toFirstUpper(_name_396);
        ...
        _builder.append("        ");
        _builder.append("qWarning() << \"cannot get ");
        String _typeName_86 = this._cppExtensions.toTypeName(feature_19);
        ...
        _builder.append("::clear");
        String _name_399 = this._cppExtensions.toName(feature_19);
        String _firstUpper_175 = StringExtensions.toFirstUpper(_name_399);
        _builder.append(_firstUpper_175, "");
        _builder.append("Property(QDeclarativeListProperty<");
        String _typeName_87 = this._cppExtensions.toTypeName(feature_19);
        _builder.append(_typeName_87, "");
        _builder.append("> *");
        String _name_400 = this._cppExtensions.toName(feature_19);
        ...
        String _firstLower_72 = StringExtensions.toFirstLower(_name_402);
        _builder.append(_firstLower_72, "    ");
        _builder.append(" = qobject_cast<");
        String _name_403 = this._cppExtensions.toName(dto);
        _builder.append(_name_403, "    ");
        _builder.append(" *>(");
        String _name_404 = this._cppExtensions.toName(feature_19);
        ...
        String _firstLower_73 = StringExtensions.toFirstLower(_name_405);
        _builder.append(_firstLower_73, "    ");
        _builder.append(") {");
        _builder.newLineIfNotEmpty();
        {
          boolean _hasOpposite_2 = this._cppExtensions.hasOpposite(feature_19);
          if (_hasOpposite_2) {
            _builder.append("        ");
            _builder.append("// ");
            String _name_406 = this._cppExtensions.toName(feature_19);
            ...
            String _firstLower_74 = StringExtensions.toFirstLower(_name_407);
            _builder.append(_firstLower_74, "        ");
            _builder.append("->m");
            String _name_408 = this._cppExtensions.toName(feature_19);
            String _firstUpper_176 = StringExtensions.toFirstUpper(_name_408);
            ...
            String _firstLower_75 = StringExtensions.toFirstLower(_name_409);
            _builder.append(_firstLower_75, "            ");
            _builder.append("->m");
            String _name_410 = this._cppExtensions.toName(feature_19);
            String _firstUpper_177 = StringExtensions.toFirstUpper(_name_410);
            ...
            _builder.append("        ");
            _builder.append("// ");
            String _name_411 = this._cppExtensions.toName(feature_19);
        ...
        String _firstLower_76 = StringExtensions.toFirstLower(_name_412);
        _builder.append(_firstLower_76, "        ");
        _builder.append("->m");
        String _name_413 = this._cppExtensions.toName(feature_19);
        String _firstUpper_178 = StringExtensions.toFirstUpper(_name_413);
        ...
        String _name_414 = this._cppExtensions.toName(feature_19);
