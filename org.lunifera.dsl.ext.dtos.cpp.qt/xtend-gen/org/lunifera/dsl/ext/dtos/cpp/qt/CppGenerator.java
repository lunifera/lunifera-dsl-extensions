  ...
  public CharSequence toContent(final LDto dto) {
              ...
              if (_not_2) {
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_isToMany_2) {
                    ...
                    String _firstUpper_37 = StringExtensions.toFirstUpper(_name_88);
                    _builder.append(_firstUpper_37, "\t\t");
                    _builder.append("->to");
                    String _mapOrList_2 = this._cppExtensions.toMapOrList(feature_7);
    ...
    _builder.newLine();
    {
      ...
      for(final LFeature feature_9 : _filter_5) {
        CharSequence _foo = this.foo(feature_9);
        _builder.append(_foo, "");
        _builder.newLineIfNotEmpty();
        {
          boolean _and_2 = false;
          boolean _isTypeOfDTO_6 = this._cppExtensions.isTypeOfDTO(feature_9);
          if (!_isTypeOfDTO_6) {
            _and_2 = false;
          } else {
            boolean _isContained_7 = this._cppExtensions.isContained(feature_9);
          ...
          if (_and_2) {
            ...
            String _firstUpper_45 = StringExtensions.toFirstUpper(_name_103);
            ...
            _builder.append(" ");
            String _name_104 = this._cppExtensions.toName(feature_9);
            ...
            _builder.append("\t");
            _builder.append("if (");
            String _name_105 = this._cppExtensions.toName(feature_9);
            _builder.append(_name_105, "\t");
            _builder.append(" != m");
            String _name_106 = this._cppExtensions.toName(feature_9);
            String _firstUpper_46 = StringExtensions.toFirstUpper(_name_106);
            _builder.append(_firstUpper_46, "\t");
            _builder.append(") {");
            _builder.newLineIfNotEmpty();
            {
              boolean _isTypeOfDTO_7 = this._cppExtensions.isTypeOfDTO(feature_9);
              if (_isTypeOfDTO_7) {
                _builder.append("\t\t");
                _builder.append("if (m");
                String _name_107 = this._cppExtensions.toName(feature_9);
                String _firstUpper_47 = StringExtensions.toFirstUpper(_name_107);
                ...
                _builder.append("\t");
                _builder.append("m");
                String _name_108 = this._cppExtensions.toName(feature_9);
                ...
                _builder.append("\t\t");
                _builder.append("m");
                String _name_109 = this._cppExtensions.toName(feature_9);
                String _firstUpper_49 = StringExtensions.toFirstUpper(_name_109);
                _builder.append(_firstUpper_49, "\t\t");
                _builder.append(" = ");
                String _name_110 = this._cppExtensions.toName(feature_9);
                _builder.append(_name_110, "\t\t");
                _builder.append(";");
                _builder.newLineIfNotEmpty();
                _builder.append("\t\t");
                _builder.append("m");
                String _name_111 = this._cppExtensions.toName(feature_9);
                String _firstUpper_50 = StringExtensions.toFirstUpper(_name_111);
                ...
                _builder.append("\t\t");
                _builder.append("m");
                String _name_112 = this._cppExtensions.toName(feature_9);
                String _firstUpper_51 = StringExtensions.toFirstUpper(_name_112);
                _builder.append(_firstUpper_51, "\t\t");
                _builder.append(" = ");
                String _name_113 = this._cppExtensions.toName(feature_9);
            ...
            String _name_114 = this._cppExtensions.toName(feature_9);
            _builder.append(_name_114, "\t\t");
            _builder.append("Changed(");
            String _name_115 = this._cppExtensions.toName(feature_9);
            ...
            _builder.newLine();
            {
              boolean _isTypeOfDTO_8 = this._cppExtensions.isTypeOfDTO(feature_9);
              if (_isTypeOfDTO_8) {
                _builder.append("void ");
                String _name_116 = this._cppExtensions.toName(dto);
                _builder.append(_name_116, "");
                _builder.append("::delete");
                String _name_117 = this._cppExtensions.toName(feature_9);
                String _firstUpper_52 = StringExtensions.toFirstUpper(_name_117);
                ...
                _builder.append("\t");
                _builder.append("if (m");
                String _name_118 = this._cppExtensions.toName(feature_9);
                String _firstUpper_53 = StringExtensions.toFirstUpper(_name_118);
                _builder.append(_firstUpper_53, "\t");
                _builder.append("){");
                _builder.newLineIfNotEmpty();
                _builder.append("\t\t");
                _builder.append("emit ");
                String _name_119 = this._cppExtensions.toName(feature_9);
                String _firstLower_13 = StringExtensions.toFirstLower(_name_119);
                _builder.append(_firstLower_13, "\t\t");
                _builder.append("Deleted(m");
                String _name_120 = this._cppExtensions.toName(feature_9);
                String _firstUpper_54 = StringExtensions.toFirstUpper(_name_120);
                _builder.append(_firstUpper_54, "\t\t");
                _builder.append("->uuid());");
                _builder.newLineIfNotEmpty();
                _builder.append("\t\t");
                _builder.append("m");
                String _name_121 = this._cppExtensions.toName(feature_9);
                String _firstUpper_55 = StringExtensions.toFirstUpper(_name_121);
                _builder.append(_firstUpper_55, "\t\t");
                _builder.append("->deleteLater();");
                _builder.newLineIfNotEmpty();
                _builder.append("\t\t");
                _builder.append("m");
                String _name_122 = this._cppExtensions.toName(feature_9);
                ...
                _builder.append("::has");
                String _name_124 = this._cppExtensions.toName(feature_9);
                String _firstUpper_57 = StringExtensions.toFirstUpper(_name_124);
                ...
                String _firstUpper_58 = StringExtensions.toFirstUpper(_name_125);
    ...
    }
    {
      ...
      for(final LFeature feature_10 : _filter_6) {
        CharSequence _foo_1 = this.foo(feature_10);
        ...
        _builder.append("\t");
        _builder.append("QVariantList ");
        String _name_128 = this._cppExtensions.toName(feature_10);
        ...
        String _firstUpper_59 = StringExtensions.toFirstUpper(_name_129);
        _builder.append(_firstUpper_59, "\t");
        _builder.append(".size(); ++i) {");
        _builder.newLineIfNotEmpty();
        _builder.append("        ");
        String _name_130 = this._cppExtensions.toName(feature_10);
        ...
        String _firstUpper_60 = StringExtensions.toFirstUpper(_name_131);
        ...
        String _firstUpper_61 = StringExtensions.toFirstUpper(_name_134);
        ...
        String _firstUpper_62 = StringExtensions.toFirstUpper(_name_135);
        ...
        String _firstUpper_64 = StringExtensions.toFirstUpper(_name_138);
        ...
        String _firstLower_18 = StringExtensions.toFirstLower(_name_141);
        ...
        String _firstUpper_67 = StringExtensions.toFirstUpper(_name_143);
        _builder.append(_firstUpper_67, "");
        _builder.append("FromMap(const QVariantMap& ");
        String _typeName_25 = this._cppExtensions.toTypeName(feature_10);
        ...
        String _firstUpper_68 = StringExtensions.toFirstUpper(_name_144);
        _builder.append(_firstUpper_68, "    ");
        _builder.append(".append(");
        String _typeName_32 = this._cppExtensions.toTypeName(feature_10);
        ...
        String _firstUpper_69 = StringExtensions.toFirstUpper(_name_146);
        ...
        String _firstUpper_70 = StringExtensions.toFirstUpper(_name_147);
        _builder.append(_firstUpper_70, "    ");
        _builder.append(".size(); ++i) {");
        _builder.newLineIfNotEmpty();
        _builder.append("        ");
        _builder.append("if (qobject_cast<");
        String _typeName_33 = this._cppExtensions.toTypeName(feature_10);
        ...
        String _firstLower_25 = StringExtensions.toFirstLower(_name_150);
        ...
        _builder.append("::");
        String _name_152 = this._cppExtensions.toName(feature_10);
        String _firstLower_26 = StringExtensions.toFirstLower(_name_152);
        ...
        _builder.append("::");
        String _name_155 = this._cppExtensions.toName(feature_10);
        ...
        String _firstUpper_74 = StringExtensions.toFirstUpper(_name_156);
        ...
        String _firstUpper_75 = StringExtensions.toFirstUpper(_name_158);
        ...
        _builder.append("\t");
        _builder.append("if (");
        String _name_160 = this._cppExtensions.toName(feature_10);
        ...
        String _firstUpper_77 = StringExtensions.toFirstUpper(_name_162);
